...
<html>
    <head>
        ...
        <link href="/backend/css/user-dashboard.css" rel="stylesheet" type="text/css" />    
    </head>
    <body class="skin-black">
        <!-- header logo: style can be found in header.less -->
        <header class="header">
            <a href="{{route('home')}}" class="logo"> <img class="user-bckend-logo" src="/images/fws-logo.png" alt=""/></a>
