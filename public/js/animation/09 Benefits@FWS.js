...
(lib.Tween7copy2 = function(mode,startPosition,loop) {
	...
	// LEFT ARM
	this.instance_1 = new lib.LEFTARMcopy3("synched",0);
...
(lib.Tween6copy2 = function(mode,startPosition,loop) {
	...
	// LEFT ARM
	this.instance_2 = new lib.LEFTARMcopy3("synched",0);
	this.instance_2.parent = this;
...
(lib.Thalay = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		playSound("BenefitsFlatworld");
	}

	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(426));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(7).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:26},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:0},0).wait(12).to({startPosition:10},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:41},0).wait(1).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(1).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:16},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(1).to({startPosition:16},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:16},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:21},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(3).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:31},0).wait(4).to({startPosition:36},0).wait(2).to({startPosition:26},0).wait(3).to({startPosition:36},0).wait(4).to({startPosition:0},0).wait(9).to({startPosition:26},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:5},0).wait(3).to({startPosition:16},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:26},0).wait(3).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:10},0).wait(6).to({startPosition:0},0).wait(10).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:26},0).wait(2).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(1).to({startPosition:5},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:16},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:0},0).wait(3).to({startPosition:36},0).wait(1).to({startPosition:16},0).wait(2).to({startPosition:26},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:16},0).wait(1).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(5).to({startPosition:0},0).wait(202));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjHAiQgogEgrgPQATgbAegNQgIAxAqAKQABAAACAAQAKAAAKABAjpgZQAUgIAYgCQAQgCAOACQASAvgjAXACZgDQgUApAhAXQgjgGgigMQANgpArgFQARgCAXAEQARACAPAFQAFAugjAMACmA9QAOACAPABAifgjQA1AHANAxQgoANgrABAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_21.setTransform(59.4,68.4);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAiYABQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQALAeAegBQAfgBAJgbgACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALAjpAAQAsgDAlAEACVgfQA8gGAvAiACVAbQAngEAlAK");
	this.shape_22.setTransform(59.4,68.7);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAiYABQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQALAeAegBQAfgBAJgbgACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALAjpAAQAsgDAlAEACVAbQAngEAlAKACVgfQA8gGAvAi");
	this.shape_23.setTransform(59.4,68.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjHAiQgogEgrgPQATgbAegNQAUgIAYgCQAQgCAOACQASAvgjAXAjHAiQABAAACAAQAKAAAKABAjpgZQgIAxAqAKACZgDQgUApAhAXQgjgGgigMQANgpArgFQARgCAXAEQARACAPAFQAFAugjAMACmA9QAOACAPABAifgjQA1AHANAxQgoANgrABAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_24.setTransform(59.4,68.4);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_25.setTransform(59.3,68);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_26.setTransform(59.3,68);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},12).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_15}]},2).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},9).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_18}]},23).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_19}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_17},{t:this.shape_3},{t:this.shape_1},{t:this.shape_20}]},8).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_21}]},78).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_22}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_23}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_24}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_25}]},1).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_18}]},26).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_19}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_17},{t:this.shape_3},{t:this.shape_1},{t:this.shape_26}]},8).wait(275));
	...
	// Layer 1
	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#000000").ss(1,1,1).p("AmqBiQAdAEAfCAIAdlcIgNiyQATgNAUgMQCqheEUAzQCagcB5BRIAQDNIAfEUAHnDRQgXgqgDBMQgBAYgBARQgDASgCAMQgDAQgFAGQgbA8AcgQAnmC5QAJgLAIgHQA4gzABBnQAAAegVAQQggARAtAkQAwAlgiAUAAgEMQAJgLAogGADliLQhLAnAABhQAEB1ATBxQgGAQhQAj");
	this.shape_27.setTransform(48.9,68.9);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f().s("#000000").ss(2,1,1).p("AGVFuIgOBMQgSBBgeAdQgoA5gvAyQg8A+hHA0Ih6AAQhLgvg4glQglgXgcgVQhHg1gLgbIg7iiIgMghQiOAsgfjcQgUiEBugGIgKh9IgTj5QggAPgmArQAblhGVhiQHchoB+EMQAXBJg5BYQBIAxgTBZIghCxIgiCwQA5ATgPBOIgnCPQgLApgtgEgAHKBZIgFAXIgwD+");
	this.shape_28.setTransform(49.2,74.7);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.lf(["#323232","#DEB17F"],[0.004,1],0,-9.9,3,9.2).s().p("AgnAqIgKh8IBihcIgdFcQgeh/gdgFg");
	this.shape_29.setTransform(10.2,74.5);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.lf(["#323232","#DEB17F"],[0.004,1],0.3,-6,1.5,7.1).s().p("AghiKIBDBNIghCwIgEAYg");
	this.shape_30.setTransform(95,72.1);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#C2894C").s().p("AkWGpIg7iiIgijYIAdlcIgOiyQATgNAUgMIAXDVQgFAngEAoQgXEUBSFSQAQBEAhAiQhIg1gLgagAG4CZQAFgGADgQQAPgBgWBDQgGAEgDAAQgNAAAVgwgAnFChQgohgAShPQA4g0ACBmQgBAegVARQggAQAtAkQAwAlghAVQgFABgEAAQgTAAgOghgAHFBmIACgqQAEhLAWApQgIBPgOAAQgDAAgDgDgAAlgNIAQAmQghABgSAeg");
	this.shape_31.setTransform(49.5,87.2);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#323232").s().p("AnKBXQggAOgmArQAblfGVhjQHchnB+ELQAXBKg5BWQBIAygTBYIghCxIhFhNIgQjNQh6hQiZAcQkUgyiqBdQgUALgTAOIANCxIhjBcg");
	this.shape_32.setTransform(49.2,32.6);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#DEB17F").s().p("");
	this.shape_33.setTransform(48.2,90.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27}]}).wait(463));
...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	// HEAD
	this.instance = new lib.Symbol2("synched",130);
	this.instance.parent = this;
	this.instance.setTransform(899.6,195.7,1,1,1.3,0,0,54.2,151.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(130).to({_off:false},0).to({rotation:1.5,startPosition:142},12).to({regX:54.4,rotation:-1.5,x:899.8,startPosition:150},8,cjs.Ease.get(1)).to({startPosition:238},88).to({_off:true},226).wait(284));

	// Layer 1
	this.instance_1 = new lib.HANDcopy2("synched",0);
	this.instance_1.parent = this;
	...
	this.instance_3 = new lib.Tween6copy("synched",0);
	this.instance_3.parent = this;
	...
	// LEFT HAND
	this.instance_4 = new lib.HANDcopy2("synched",0);
	this.instance_4.parent = this;
	...
	// Layer 2
	this.instance_5 = new lib.LEFTARMcopy2("synched",0);
	this.instance_5.parent = this;
	...
	this.instance_7 = new lib.LEFTARMcopy2("synched",0);
	...
	this.instance_8 = new lib.Tween4copy("synched",0);
	...
	// Layer 3
	this.instance_10 = new lib.LEFTSHOULDERcopy("synched",0);
	...
	// LEFT SHOULDER
	this.instance_11 = new lib.LEFTSHOULDERcopy("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(775.6,332.6,1,1,0,0,180,31.2,95.6);
	this.instance_11._off = true;

	this.instance_12 = new lib.LEFTSHOULDERcopy("synched",0);
	...
	// ID
	this.instance_16 = new lib.Symbol6copy("synched",0);
	...
	// BODY
	this.instance_17 = new lib.BODYcopy("synched",0);
...
(lib.Wholeguy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(130).to({_off:false},0).to({startPosition:137},7).to({scaleY:0.99,startPosition:141},4).to({regY:582.2,scaleY:1.01,skewX:-1.8,skewY:-1,x:886.6,startPosition:147},6,cjs.Ease.get(1)).to({startPosition:174},27).to({regY:582.3,scaleY:0.99,skewX:0,skewY:0,x:893,startPosition:182},8,cjs.Ease.get(1)).to({scaleY:1,startPosition:191},9).to({startPosition:238},47).wait(226));
	...
	// SHOE
	this.instance_5 = new lib.LEFTSHOEcopy("synched",0);
	this.instance_5.parent = this;
	...
	// HAND
	this.instance_9 = new lib.Tween6copy2("synched",0);
	this.instance_9.parent = this;
	...
	// HAND
	this.instance_10 = new lib.Tween7copy2("synched",0);
	this.instance_10.parent = this;
	...
	// Symbol 6
	this.instance_12 = new lib.Symbol6copy2("synched",0);
	this.instance_12.parent = this;
	...
	// Layer 13
	this.instance_14 = new lib.Tween4copy2("synched",0);
	this.instance_14.parent = this;
	...
	// BODY
	this.instance_15 = new lib.BODYcopy2("synched",0);
	this.instance_15.parent = this;
	...
	// LEFT THIGH
	this.instance_16 = new lib.LEFTTHIGHcopy2("synched",0);
	this.instance_16.parent = this;
	...
	// LEFT THIGH
	this.instance_17 = new lib.LEFTTHIGHcopy2("synched",0);
	this.instance_17.parent = this;
	...
	// LEFT LEG
	this.instance_18 = new lib.LEFTLEGcopy2("synched",0);
	...
	// LEFT LEG
	this.instance_19 = new lib.LEFTLEGcopy2("synched",0);
	...
	// LEFT SHOE
	this.instance_20 = new lib.LEFTSHOEcopy2("synched",0);
	...
	// LEFT SHOE
	this.instance_21 = new lib.LEFTSHOEcopy2("synched",0);
...
// stage content:
(lib._09BenefitsFWS = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(235));

	// Layer 3
	this.instance = new lib.Wholeguy("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(246.7,708.2,0.695,0.695,0,0,0,893.8,1052.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(239));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(377.8,363.8,207.6,702.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"/sounds/benifits/BenefitsFlatworld.mp3", id:"BenefitsFlatworld"}
	],
	preloads: []
};
