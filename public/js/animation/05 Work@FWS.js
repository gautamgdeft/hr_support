...
(lib.Twefn1ycopy = function(mode,startPosition,loop) {
...
(lib.Tween17copy = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#C2894C").s().p("AhSEaIjblSIAVh/QAPhRBMgeIBxgSIBWAGIAjAFQBFAJAzARIAOAEIAXAKIAEACQARAIAOAKQAMAIAKAJQAaAYAKAfIADAIIAAABIAAAJQAAATgIAdIjNGBQgnAfgrAAQgoAAgtgfgAEihnQgJAxgCAaQACgaAJgxQAIgdAAgTIAAgJQAIAfgHAmQgDAigRAdIgHANgAEqigIAAAAg");
...
(lib.Tween16copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("AlQjRQgIgoAEgjAlQjRQAfg4ADg0QgOAAgMADQgjAIgcAWQg7AvgfByQgHAcgGAfQgRCAAtDdQAKgVAJgUQCMkXCTCTQBEBWBgB8QBZh8BDhXQCPiNCIECQAOAaANAfQAujdgSiAQgFgfgIgcQggh5hBguQgagSgegGQgMgDgHgEQAIA4ATA4QAJgogEgjAigBwQiVjAgbiBACgBvQCWi/AaiB");
...
(lib.Tween13copy = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(2,1,1).p("AlUk/QAngTAkgYQBthKBWh7ICvkuQAygQAOA4IikFeIFikuQA0AFgMBFIgSATIkUEfAF9qoQA0ASgMA7Ij4E2QgXApE3htQAjADgRArIkICoQhoB9h8BYQgiAYgjALQgnAMgpgDAlUk/QgGh7gihfQg0hYg0AQQAWClgWCfIBkDGIAAAWIAACNIAAE4QAJB+A7B+AhPBtQAWAfASAgQBsC+gbDhQgRCNhrCKAlUk/QCNBOgLB4");
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#C2894C").s().p("AhnGnQg8h9gJh/IAAk2IAAiOIAAgXIACAYIABAdQAFA8gIA0QAbCsAYCCQAbCUAoBgQgRBiATBLQgdg8gWhhgAiqkYIgCgBgABphMQAUgOAEgYIADAIQAWAfASAgQgngPgcgSgAh/oXQAmgTAkgYQBaB4gkB5QALh4iLhOg");
	this.shape_3.setTransform(-21.2,20.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#DEB17F").s().p("");
...
(lib.Tween12copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("ABtAZQAEgCgCADIANgEIAkgKABwAaQADAAAIgEIAVgFIAQgEAifgqQBBBeB+gKIBCgMIALgF");
...
(lib.Tween4copy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.Tween3copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("AlUA6QAngTAkgYQBthJBWh7ICvkuQAygQAOA4IikFeIFikuQA0AFgMBFIgSATIkUEfAF9kuQA0ASgMA7Ij4E1QgXApE3htQAjADgRArIkICoQiCCfi6BWQgGADgdAKAlUA6QgGh6gihfQg0hYg0AQQAWClgWCeICDEoAlUA6QCNBOgLB4");
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DEB17F").s().p("AjPHpQgrgFhIhFQhIhEApAmIiDkpQAWidgWimQA0gPA0BXQAiBgAGB5QCNBPgLB3QAkh4hbh5QBthJBWh7ICvkuQAygPAOA3IikFeIFikuQA0AGgMBEIgSAUIkUEeIEUkeQA0ARgMA7Ij4E1QgXApE3htQAjADgRArIkICoQiCCfi6BWQgGAEgdAKQgSAGgYAAQgOAAgPgCg");
...
(lib.Symbol6copy2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("AiFhZIAiAeIAACHIgiAnIAAjMIAAhxIELAAIAABxIgkAeIAACHIAkAnIAABYIkLAAIAAhYACGhZIAADM");
...
(lib.Lipycopy = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("AARjiIj5BTIgEBpIAqg8IDCgQIAOgaIAOAaICwgEIAWA+IALhhQhuguhugbgAgmA7IAOAmIA3ACIAJgqgAC6DDIAFhlQg4Btg5AOQgmAMgJgrIhEgBQgOAfgQAHQhZAbg3iDIAMBrAg1gdQBDASA1gYAighNQDHAPCJgj");
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_8.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_13.graphics.f().s("#000000").ss(1,1,1).p("ABEguQAIAZgZAQQgaAPgYAAQgXAAgdgOQgdgQAMgZQALgZASgRQARgRAXAAQAYAAASARQASARAHAYgAANjoIjpBTQADA3AIA3IAZhBQBegOBYgBIAMgbIANAbQBUgGBSACIALBCQAPgyAGgzQhogvhogbgAgpBOIAOAnIA3ABIAJgqgACqDJIAFhlQg0Btg1AOQgkAMgIgsIg/AAQgOAegOAHQhUAbgziDIALBr");
	...
	this.shape_17.graphics.f().s("#000000").ss(1,1,1).p("AAtguQAAAWgLAQQgLAPgQAAQgPAAgLgPQgLgQAAgWQAAgWALgRQALgPAPAAQAQAAALAPQALARAAAWgAANjoIjpBTQADA3AIA3IAZhBQBegOBYgBIAMgbIANAbQBUgGBSACIALBCQAPgyAGgzQhogvhogbgAgpBOIAOAnIA3ABIAJgqgACqDJIAFhlQg0Btg1AOQgkAMgIgsIg/AAQgOAegOAHQhUAbgziDIALBr");
	...
	this.shape_21.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_26.graphics.f().s("#000000").ss(1,1,1).p("ABlANQBDgkAfhZAhOAYQAmAOAuAAQA2gDApgWAiyhZQBPA4BzgKQB0gKBDg7AATjmQh9Ath/AgIgKBmIAog6IDNgIIAOgbIAOAbIC7gNIAbA+IAAhlQh5gXhogmgAhOAYQhMgbgihWQAFAAAFAAQC5ADDAgaAgjBLIAOAnIA2ABIAKgqgAC8DHIAGhlQg5Btg5AOQgmAMgIgsIhEAAQgOAegQAHQhZAbg3iDIALBrAhOAYQBZgnBaAc");
	...
	this.shape_35.graphics.f().s("#000000").ss(1,1,1).p("");
...
(lib.LEFTTHIGHcopy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.LEFTTHIGHcopy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.LEFTSHOULDERcopy5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("Ahju3QESCYAqINIBTIyQgNAGgNAGAjGFyQDrAhDjhiQAFgDAFgCAjGFyIA+FvIABAGQAVDmC/gXQDpgEgSjoQAFg/gDg9IgSkBIgCghAkrk5IA+KkQATAEAUAD");
...
(lib.LEFTSHOULDERcopy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("AhjutQESCYAqINIBTIyQgNAGgNAGAjGF8QDrAhDjhiQAFgDAFgCAjGF8IA/F1QAGDDCCgGQAOAAANgBQADAAACAAQDKgNAniMQAOgcAFgyQAAgCAAgCQAEgtgDg9IgSkBIgCghAkrkvIA+KkQATAEAUAD");
...
(lib.LEFTSHOULDERcopy = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("AhjutQESCYAqINIBTIyQgNAGgNAGAjGF8QDrAhDjhiQAFgDAFgCAElLGQAAgCAAgCQAEgtgDg9IgSkBIgCghAkrkvIA+KkQATAEAUADIA/F1QAGDDCCgGQAOAAANgB");
	this.shape.setTransform(31.5,97);
...
(lib.LEFTSHOEcopy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.LEFTSHOEcopy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.LEFTLEGcopy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.LEFTARMcopy5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.LEFTARMcopy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DEB180").s().p("AhXNRQhngYgFg7QgFg7ACgVQAwjhgVk3QgusJAdipQAuhEBagEQC8gHA2BrQAFAJADAKIgIgBQgSG1hZOIIAJACQgNA1gGAtIgQBsQgJA/gRAGIgJABQgaAAhTgUgADGrtIACAEIAAABIAAACIgCgHg");
...
(lib.LEFTARMcopy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("ADOsCQAEAOAEARQAAAEABAEQATBpgQDSQgzI8g7G/QgNBSgNBWAjXqXQgaIMAxFiQAbD0gSDtQgCAWgCAV");
	this.shape.setTransform(22.5,85.9);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DEB180").s().p("AhUN2Qh9gOAJihIAEgrQAwjhgVk3QgusJAdipQAuhEBagEQC8gHA2BrQAFAJADAKIgIgBQgSG1hZOIIAJACIgaCoQgcCQhnAAIgVgBgADIr/IACAEIAAABIAAACIgCgHg");
	this.shape_2.setTransform(23.8,88.7);
...
(lib.HANDcopy5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.HANDcopy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.BODYcopy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("Ang70QjjCzlDB+QjIBvAiFKQABAHACAIQALBCAPBGQABAAAAABQAgCMAzCbQAIAgBEEqQA7EEgLHpQgCBGgDBKQgZJVgSHaQAkAlAzAfIABAAQEDCZKAAAQAKAAAKAAQALAAALAAQMAAADbjdQgTnagZpVQgYpUBEkpQBDkqAJggQBPjyAhjNQAEghABgeQAKkSiwhlQgCgCgDgBQlDh+jiizQj5iVj1ADQkBADjTCPg");
	this.shape.setTransform(120.2,192.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AivATIAAgIIEHAAIAAAIgAB0AJQAFAHAHgDQAGgDADgFIgEgFIgHgHQgEgFgBgEIADADIAHAIIAIAIIAJgKQAHgIAKAEQAQAGgHAPIgCACQgRALgOgPQgFAIgIABIgEABQgIAAAAgJgACVgCIgHAIQAEAFAGACQAKAEAGgJQAHgIgKgHIgEgBQgHAAgFAGgAirgMIAAgGIDxAAIAAAGg");
	this.shape_1.setTransform(55.4,106.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("AgaAbQgLgMAAgPQAAgOALgMQAMgLAOAAQAQAAALALQALAMAAAOQAAAPgLAMQgLALgQAAQgOAAgMgLgAgXAQQAIgBAFgIQANAPARgLIACgCQAHgPgQgGQgKgEgFAIIgJAKIgJgIIgGgIIgEgDQABAEAEAFIAHAIIAEAEQgCAFgHADQgHADgFgHQAAALAMgDgAAAAMQgFgCgDgFIAHgIQAFgHAJACQAKAHgGAIQgFAGgGAAIgGgBg");
	this.shape_2.setTransform(70.6,106.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A4A").s().p("");
	this.shape_3.setTransform(120.2,192.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2D2D2D").s().p("AOQWNIgCgFIga05QgVoqCTnlIAAgBIAHgVIBkj+QAphrAhhNIgCAgQgMBJgRBOIgrABIArAAQghCMgzCbQgIAghDEqQg8EFAMHoIAECQQAZJVATHaQglAlgzAfgAuVWNQg0gfgjglQASnaAZpVIAEiQQAMnog7kFQhEkqgIggQgzibghiMIAtAAIBiD+IAHAVIAAABQCSHlgUIqIgaU5IgCAFgAxfzUgAyMzVQgPhGgMhCQAkA5AkBQg");
	this.shape_4.setTransform(119.9,228.1);
...
(lib.BODYcopy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("Anh70QjiCzlDB+QjJBvAjFKQALBJASBOQAAAAAAABQAgCMAzCbQAJAgBDEqQA8EEgMHpQgBBGgDBKQgZJVgTHaQAkAlA0AfIAAAAQEDCZKAAAQALAAAKAAQALAAAKAAQMBAADbjdQgTnagZpVQgYpUBEkpQBDkqAJggQBPjyAhjNQAjlKjJhvQlDh+jjizQj5iVj1ADQkBADjTCPg");
	this.shape.setTransform(120.2,192.7);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A4A").s().p("");
	this.shape_3.setTransform(121.9,192.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2D2D2D").s().p("");
	this.shape_4.setTransform(119.7,207.7);
...
(lib.Tween7copy2 = function(mode,startPosition,loop) {
	...
	// HAND
	this.instance = new lib.HANDcopy5("synched",0);
	...
	// LEFT ARM
	this.instance_1 = new lib.LEFTARMcopy5("synched",0);
	...
	// LEFT SHOULDER
	this.instance_2 = new lib.LEFTSHOULDERcopy5("synched",0);
...
(lib.Thalaycopy = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
(lib.Symbol10copy = function(mode,startPosition,loop) {
	...
	// Layer 6
	this.instance = new lib.HANDcopy2("synched",0);
	this.instance.parent = this;
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#DEB180").s().p("");
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(2,1,1).p("");
	this.shape_11.setTransform(772.4,594.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#DEB180").s().p("");
	...
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#000000").ss(2,1,1).p("");
	this.shape_17.setTransform(772.4,594.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#DEB180").s().p("");
...
(lib.Symbol2copy2 = function(mode,startPosition,loop) {
	...
	// Layer 8
	this.instance = new lib.Thalaycopy("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(48,129,0.99,0.99,0,-0.7,179.3,1245.4,201.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},189).wait(1).to({_off:false,y:128.9,startPosition:190},0).wait(224));

	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape.setTransform(41.2,68);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#C2894C").s().p("AjZgMQA1gIAmAXQhWgIhBAyQAJgtAzgMgAB1gRQAUgaAygBQA8ACAfAtQhKgphXAVg");
	this.shape_1.setTransform(40.8,63.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#323232").s().p("AjGA4IAbgDIgGABIgDAAIgCAAIgCABIgJABIgEAAIgBAAgAjSAxQgOgJgEgQQgDgRAJgOQAJgOAPgDQARgEAOAKQAOAJAEAQQADARgJAOQgGAJgJAGIgBAAIgbADIgFAAIgHgHgAirA1IAAAAgACwAZQgLgDgHgKQgLgMABgQQACgRANgMQANgLARABQARACALAMQAKAOgBARQgBAQgNALIgJAHIgDAAIgFABIgCAAIgEAAIgJABIgIgBg");
	this.shape_2.setTransform(41.7,69.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(41.2,69);
	...
	this.shape_4.setTransform(41.1,68.5,1,1,0,0,180);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#C2894C").s().p("ACLAFQBOgeAvBBQg0gnhJAEgAh9gRQhJgThBAkQA8hEBOAzg");
	this.shape_5.setTransform(41,64.4,1,1,0,0,180);
	...
	this.shape_6.setTransform(41.6,69.8,1,1,0,0,180);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ADDAyQAjgMgFguQApAPARAjQglAIgkAAIgPAAgABhAdQANgpArgFQgUApAhAWQgjgFgigMgAifgxQA1AGANAyQgoANgrAAQAjgVgSgwgAkaABQATgcAegNQgIAxAqAKQgogEgrgOg");
	this.shape_7.setTransform(41.1,69.9,1,1,0,0,180);
	...
	this.shape_8.setTransform(41.1,68.8,1,1,0,0,180);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#C2894C").s().p("ACVAHQBDgiAoA+Qgvghg8AFgAiLgSQg6gLg6AdQAtg5BHAng");
	this.shape_9.setTransform(41.1,64.8,1,1,0,0,180);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#323232").s().p("ADAAfIgBAAIgGAAQgcgIgDgYQAmgEAlAJQgFAbggAAIAAAAgAjkgcQAsgEAkAFQgJAbgeAAIgCAAQgdAAgKgcg");
	this.shape_10.setTransform(41.6,71.7,1,1,0,0,180);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("ADDAeIgIgBQAgAAAGgbQAfAHAbANQglAJgkAAIgPgBgACmAbQgjgGgigMQAZgJAbgDQADAYAcAIIgOgCgAjEAAIgDAAQgogDgrgPIADgEQAagGAUgCQALAeAegBQAfgBAJgbQAgAFAbAMQgoAMgrABIgUgBg");
	this.shape_11.setTransform(41.1,71.9,1,1,0,0,180);
	...
	this.shape_12.setTransform(41.3,69.6,1,1,0,0,180);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#C2894C").s().p("ACgAJQA0gfAgA0QghgWgzABgAiVgQQg2gHgoAXQAggxA+Ahg");
	this.shape_13.setTransform(41.2,65,1,1,0,0,180);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#2B2B2B").s().p("ABogFQBZAkBIgYQggAUgjAAQgtAAgxgggAkIgaQBKAbBcgaQgpAZgpAAQgqAAgqgag");
	this.shape_14.setTransform(41.3,73.3,1,1,0,0,180);
	...
	this.shape_15.setTransform(41.1,68.8,1,1,0,0,180);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_16.setTransform(41.2,68,1,1,0,0,180);
	...
	this.shape_17.setTransform(41.7,69.2,1,1,0,0,180);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("");
	this.shape_18.setTransform(41.2,69,1,1,0,0,180);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#C2894C").s().p("AB/ADQAmgXA1AIQAzAMAJAtQhBgyhWAIgAi6gsQAyABAUAaQhXgVhKApQAfgtA8gCg");
	this.shape_19.setTransform(40.8,63.7,1,1,0,0,180);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_20.setTransform(41.2,68,1,1,0,0,180);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#323232").s().p("ADHA4IgbgDIgBAAQgJgGgGgJQgJgOADgRQAEgQAOgJQAOgKARAEQAPADAJAOQAJAOgDARQgEAQgOAJIgHAHgADCA4IgJgBIgCgBIgCAAIgDAAIgGgBIAbADIgBAAIgEAAgACsA1gAjAAZIgEAAIgCAAIgFgBIgDAAIgJgHQgNgLgBgQQgBgRAKgOQALgMARgCQARgBANALQANAMACARQABAQgLAMQgHAKgLADIgIABIgJgBg");
	this.shape_21.setTransform(41.7,69.2,1,1,0,0,180);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjHAiQgogEgrgPQATgbAegNQgIAxAqAKQABAAACAAQAKAAAKABAjpgZQAUgIAYgCQAQgCAOACQASAvgjAXACZgDQgUApAhAXQgjgGgigMQANgpArgFQARgCAXAEQARACAPAFQAFAugjAMACmA9QAOACAPABAifgjQA1AHANAxQgoANgrABAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_22.setTransform(41.1,68.5,1,1,0,0,180);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(1,1,1).p("AkIAKQBUA0BSgzQhcAbhKgcgAjzguQApgXA1AIABoAfQBXA6BKgtQhIAYhZglgAChgkQAzgBAhAX");
	this.shape_23.setTransform(41.3,69.6,1,1,0,0,180);
	...
	this.shape_24.setTransform(41.2,68,1,1,0,0,180);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjpgZQAUgIAYgCQAQgCAOACQA1AHANAxQgoANgrABAjpgZQgIAxAqAKQABAAACAAQAKAAAKABAjHAiQgogEgrgPQATgbAegNACZgDQARgCAXAEQARACAPAFQAFAugjAMAifgjQASAvgjAXACmA9QAOACAPABACmA9QgjgGgigMQANgpArgFQgUApAhAXgAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_25.setTransform(41.1,68.5,1,1,0,0,180);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAjpAAQALAeAegBQAfgBAJgbQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQAsgDAlAEACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALACVAbQAngEAlAKACVgfQA8gGAvAi");
	this.shape_26.setTransform(41.1,68.8,1,1,0,0,180);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAjpAAQALAeAegBQAfgBAJgbQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQAsgDAlAEACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALACVgfQA8gGAvAiACVAbQAngEAlAK");
	this.shape_27.setTransform(41.1,68.8,1,1,0,0,180);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjpgZQgIAxAqAKQABAAACAAQAKAAAKABAjpgZQAUgIAYgCQAQgCAOACQA1AHANAxQgoANgrABAjHAiQgogEgrgPQATgbAegNACZgDQARgCAXAEQARACAPAFQAFAugjAMAifgjQASAvgjAXACmA9QAOACAPABACmA9QgjgGgigMQANgpArgFQgUApAhAXgAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_28.setTransform(41.1,68.5,1,1,0,0,180);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_29.setTransform(41.2,68,1,1,0,0,180);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_30.setTransform(41.2,68);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_31.setTransform(41.2,68);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},12).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_21},{t:this.shape_20}]},9).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_22}]},23).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_13},{t:this.shape_14},{t:this.shape_23}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_20}]},8).to({state:[{t:this.shape_18},{t:this.shape_21},{t:this.shape_19},{t:this.shape_24}]},102).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_25}]},6).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_26}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_27}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_28}]},1).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_19},{t:this.shape_16}]},1).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_19},{t:this.shape_29}]},8).to({state:[]},3).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape_30}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_21},{t:this.shape_20}]},9).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_22}]},6).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_13},{t:this.shape_14},{t:this.shape_23}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_20}]},8).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_21},{t:this.shape_20}]},79).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_22}]},2).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_13},{t:this.shape_14},{t:this.shape_23}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_20}]},8).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_20}]},40).to({state:[{t:this.shape_18},{t:this.shape_21},{t:this.shape_19},{t:this.shape_24}]},1).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_25}]},2).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_26}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_27}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_28}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape_31}]},1).wait(51));

	// Layer 3
	this.instance_1 = new lib.Twefn1ycopy("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(42.8,54.4,1,1,0,4.4,-175.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},12).to({x:42.7,y:55.2},2).to({x:42.8,y:54.2},3).to({y:54.4},4).to({startPosition:0},6).to({startPosition:0},22).to({y:54.2},1).to({x:42.7,y:55.2},3).to({x:42.8,y:54.4},2).to({startPosition:0},8).to({startPosition:0},5).to({skewX:4.5,skewY:-175.5,y:54.5},1).to({regX:0.1,regY:0.1,skewX:4.3,skewY:-175.7,x:42.6,y:54.6},9).to({scaleX:1,scaleY:1,x:42.5,y:55.8},2).to({regY:0.2,x:42.4,y:52.1},9,cjs.Ease.get(1)).to({startPosition:0},9,cjs.Ease.get(1)).to({regX:0,regY:0,scaleX:1,scaleY:1,skewX:4.4,skewY:-175.6,x:42.8,y:54.4},6,cjs.Ease.get(1)).to({startPosition:0},18).to({startPosition:0},8).to({x:42.7,y:55.2},2).to({x:42.8,y:54.2},3).to({y:54.4},4).to({startPosition:0},6).to({regX:0.1,regY:0.1,skewX:4.3,skewY:-175.7,x:42.7,y:55},3).to({regX:0,regY:0,skewX:4.4,skewY:-175.6,x:42.8,y:54.2},11).to({startPosition:0},11).to({x:42.7,y:55.2},3).to({x:42.8,y:54.4},2).to({startPosition:0},8).to({y:51.1},5).to({_off:true},1).wait(1).to({_off:false,regY:0.1,skewX:4.3,skewY:-175.7,x:42.9,y:51.2},0).to({regY:0,skewX:4.4,skewY:-175.6,x:42.8,y:51.1},14).to({y:54.4},4).to({startPosition:0},90).to({regX:0.1,regY:0.1,skewX:4.3,skewY:-175.7,y:57},4).to({regX:0,regY:0,skewX:4.4,skewY:-175.6,y:54.4},6).to({startPosition:0},46).to({startPosition:0},1).to({regX:0.1,regY:0.1,skewX:4.3,skewY:-175.7,y:57},4).to({regX:0,regY:0,skewX:4.4,skewY:-175.6,y:54.4},6).wait(49));

	// Layer 1
	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("#000000").ss(2,1,1).p("AmUFuIAOBMQASBBAeAdQAoA5AvAyQA8A+BHA0IB6AAQBLgvA4glQAlgXAcgVQBHg1ALgbIA7iiIAMghQCOAsAfjcQAUiEhugGIAKh9IATj5QAgAPAmArQgblhmVhiQnchoh+EMQgXBJA5BYQhIAxATBZIAhCxIAiCwQg5ATAPBOIAnCPQALApAtgEgAnJBZIAFAXIAwD+");
	this.shape_32.setTransform(51.3,74.8);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("#000000").ss(1,1,1).p("AGrBiQgcAEggCAIgelcIAOiyQgTgNgUgMQiqhekUAzQiagch5BRIgQDNIgfEUAHnC5QgJgLgIgHQg4gzgCBnQABAeAVAQQAgARgtAkQgvAlAhAUAjliLQBLAnABBhQgEB1gTBxQAGAQBQAjAnmDRQAWgqAEBMQABAYABARQADASACAMQADAQAFAGQAbA8gcgQAgfEMQgJgLgogG");
	this.shape_33.setTransform(51.6,69);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.lf(["#323232","#DEB17F"],[0.004,1],-0.3,-6,-1.5,7.1).s().p("AAABzIgiiwIBFhNIgfEVg");
	this.shape_34.setTransform(5.6,72.1);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#DEB17F").s().p("");
	this.shape_35.setTransform(52.3,90.6);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.lf(["#323232","#DEB17F"],[0.004,1],0.1,-9.9,-2.9,9.2).s().p("AgxitIBiBbIgJB9QgcAEgfCAg");
	this.shape_36.setTransform(90.3,74.5);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#323232").s().p("AFVD0IANixQgTgOgUgLQiqhdkUAyQiZgch6BQIgQDNIhFBNIghixQgThYBIgyQg5hWAXhKQB+kLHcBnQGVBjAbFfQgmgrgggOIgTD5g");
	this.shape_37.setTransform(51.3,32.6);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#C2894C").s().p("AD1GSQBSlSgXkVQgEgogFgmIAXjUQAUALATAOIgOCxIAdFcIgiDXIg7CiQgLAbhIA1QAhgjAQhDgAm4DFQgWhDAPABQADAQAFAGQAVAwgNAAQgDAAgGgEgAGcDAQghgUAwglQAtgkgggRQgVgQgBgdQAChnA4AzQASBPgoBhQgOAhgTAAQgEAAgFgCgAngAbQAWgqAEBLIACApQgDAEgDAAQgOAAgIhOgAg0AZIAQgmIAjBEQgSgdghgBg");
	this.shape_38.setTransform(51,87.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32}]}).to({state:[]},189).to({state:[{t:this.shape_37},{t:this.shape_38},{t:this.shape_35},{t:this.shape_36},{t:this.shape_34},{t:this.shape_32},{t:this.shape_33}]},1).wait(224));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.6,-1.9,107.8,153.5);


(lib.cg4ybn6ujcopy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.bjntjnutujrtfiu = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 4
	this.instance = new lib.HANDcopy("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(785,597.6,1,1,0,0,180,25.6,49.7);
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#DEB180").s().p("AAXHkQjVjCgRhzQgWk7AdkfQANg/BXgGQBMgCAyBHQAlA8gHA/QgnhmgqglIA/C0ICnDHQARAagGAaQgYANgggWIhjhWIgOgMIg0gjQgsgcgUgGQAUAGAsAcQhMBagFDiQgCAUAFASIAHAQQA+B6BLBbIABABQAaAlgRAWIAAAAIgCACQgHAGgJAAQgNAAgRgNgAgZm7IgFgFIAFAFgAgFiaIAAAAg");
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#DEB180").s().p("");
	this.shape_8.setTransform(683.4,526.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#DEB180").s().p("");
	this.shape_11.setTransform(658.4,502);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.instance_1 = new lib.Tween6copy("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(657,391.9,1,1,5,0,0,46.8,18.2);
	this.instance_1._off = true;

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(2,1,1).p("");
	this.shape_15.setTransform(629.6,433.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(2,1,1).p("");
	this.shape_16.setTransform(658.4,502);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#DEB180").s().p("");
	this.shape_17.setTransform(658.4,502);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#DEB180").s().p("");
	this.shape_18.setTransform(683.4,526.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#DEB180").s().p("AAXHkQjVjCgRhzQgWk7AdkfQANg/BXgGQBMgCAyBHQAlA8gHA/QgnhmgqglIgFgFIAFAFIA/C0ICnDHQARAagGAaQgYANgggWIhjhWIgOgMIg0gjQgsgcgUgGQAUAGAsAcQhMBagFDiQgCAUAFASIAHAQQA+B6BLBbIABABQAaAlgRAWIAAAAIgCACQgHAGgJAAQgNAAgRgNg");
	this.shape_21.setTransform(746.9,573.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance}]},3).to({state:[{t:this.instance}]},1).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]},1).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},9).to({state:[{t:this.instance_1}]},6).to({state:[{t:this.instance_1}]},6).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_15}]},16).to({state:[{t:this.shape_17},{t:this.shape_10},{t:this.shape_16}]},1).to({state:[{t:this.shape_18},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19}]},1).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).wait(566));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({x:779.5},0).wait(1).to({x:774.5,y:597.4},0).to({_off:true},1).wait(47).to({_off:false},0).wait(1).to({x:779.5,y:597.6},0).wait(1).to({x:784},0).wait(566));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({_off:false},0).to({regX:46.9,rotation:-9.7,x:653,y:413.2},9,cjs.Ease.get(0.85)).to({regX:47,regY:18.3,rotation:-20.1,x:654.8,y:415.8},6,cjs.Ease.get(1)).to({regX:47.1,regY:18.4,rotation:-24.4,x:655,y:415.9},6,cjs.Ease.get(1)).to({_off:true},16).wait(573));

	// LEFT ARM
	this.instance_2 = new lib.LEFTARMcopy("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(767.3,482.2,1,1,0,0,180,22.5,88.7);
	...
	this.instance_3 = new lib.Tween4copy("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(757.8,377.7,1,1,0,0,0,55.9,-27.2);
	this.instance_3._off = true;

	this.instance_4 = new lib.Symbol7("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(721,431.8,1,1,0,0,0,52.8,51);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.shape_23},{t:this.shape_22}]},1).to({state:[{t:this.shape_25},{t:this.shape_24}]},1).to({state:[{t:this.shape_27},{t:this.shape_26}]},1).to({state:[{t:this.shape_29},{t:this.shape_28}]},1).to({state:[{t:this.shape_31},{t:this.shape_30}]},1).to({state:[{t:this.shape_33},{t:this.shape_32}]},1).to({state:[{t:this.shape_35},{t:this.shape_34}]},1).to({state:[{t:this.shape_37},{t:this.shape_36}]},1).to({state:[{t:this.shape_39},{t:this.shape_38}]},1).to({state:[{t:this.shape_41},{t:this.shape_40}]},1).to({state:[{t:this.shape_43},{t:this.shape_42}]},1).to({state:[{t:this.shape_45},{t:this.shape_44}]},1).to({state:[{t:this.shape_47},{t:this.shape_46}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},6).to({state:[{t:this.shape_29},{t:this.shape_28}]},22).to({state:[{t:this.shape_26},{t:this.instance_4}]},1).to({state:[{t:this.shape_25},{t:this.shape_24}]},1).to({state:[{t:this.shape_23},{t:this.shape_22}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).wait(566));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(3).to({regX:22.4,regY:0.1,skewX:1.5,skewY:181.5,x:766.4,y:393.6},0).wait(1).to({regX:22.5,skewX:3.2,skewY:183.2,x:766.3},0).wait(1).to({regY:0,skewX:6.2,skewY:186.2,x:766.4,y:392.5},0).to({_off:true},1).wait(45).to({_off:false},0).wait(1).to({regY:0.1,skewX:3.2,skewY:183.2,x:766.3,y:393.6},0).wait(1).to({regX:22.4,skewX:1.5,skewY:181.5,x:766.4},0).wait(1).to({regX:22.5,regY:0,skewX:0,skewY:180,x:766.3,y:393.5},0).wait(566));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(19).to({_off:false},0).to({rotation:-2.2},6,cjs.Ease.get(1)).to({_off:true},22).wait(573));

	// LEFT SHOULDER
	this.instance_5 = new lib.LEFTSHOULDERcopy("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(775.6,332.6,1,1,0,0,180,31.2,95.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(4).to({x:774.6},0).wait(1).to({regX:11.9,regY:0.6,skewX:0.4,skewY:180.4,x:793.9,y:237.6},0).wait(1).to({regX:-4.9,regY:-2.5,skewX:1.5,skewY:181.5,x:810.7,y:234.5},0).wait(1).to({regX:52.6,regY:183.2,skewX:3.7,skewY:183.7,x:744.5,y:417.3},0).wait(1).to({regX:7.8,regY:1.9,skewX:6.2,skewY:186.2,x:804,y:237.2},0).wait(1).to({regX:-0.1,regY:0.1,skewX:9.8,skewY:189.8,x:819.1,y:235.1},0).wait(1).to({skewX:10.8,skewY:190.8},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:-0.2,skewX:11.1,skewY:191.1,x:819.2},0).wait(1).to({regX:-0.3,regY:0.2,skewX:11.5,skewY:191.5,y:235.2},0).wait(1).to({regX:-0.4,skewX:12,skewY:192,x:819.3,y:235.3},0).wait(1).to({startPosition:0},0).wait(2).to({regX:-0.1,regY:0.1,skewX:12.1,skewY:192.1,x:819.1,y:235.1},0).wait(1).to({skewX:12.6,skewY:192.6,x:819.8,y:235.6},0).wait(28).to({skewX:9.8,skewY:189.8,x:819.1,y:235.1},0).wait(1).to({regX:7.8,regY:1.9,skewX:6.2,skewY:186.2,x:804,y:237.2},0).wait(1).to({regX:52.6,regY:183.2,skewX:3.7,skewY:183.7,x:744.5,y:417.3},0).wait(1).to({regX:-4.9,regY:-2.5,skewX:1.5,skewY:181.5,x:810.7,y:234.5},0).wait(1).to({regX:11.9,regY:0.6,skewX:0.4,skewY:180.4,x:793.9,y:237.6},0).wait(1).to({regX:31.2,regY:95.6,skewX:0,skewY:180,x:774.6,y:332.6},0).wait(1).to({startPosition:0},0).wait(567));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(743.8,237,67.8,410.3);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(473));

	// HEAD
	this.instance = new lib.Symbol2copy2("synched",190);
	this.instance.parent = this;
	this.instance.setTransform(899.8,195.7,1,1,-1.3,0,0,54.4,151.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(190).to({_off:false},0).to({regY:151.1,rotation:-1.5,startPosition:234},44).to({regY:151.2,rotation:-5,x:902.2,y:194.9,startPosition:241},7).to({regY:151.1,rotation:-1.5,x:899.8,y:195.7,startPosition:248},7).to({startPosition:280},32).to({regY:151.2,rotation:-1.3,startPosition:313},33).to({rotation:0.3,y:198.1,startPosition:318},5).to({rotation:3,x:899.7,y:195.8,startPosition:325},7).to({rotation:2.8,x:899.8,startPosition:353},28).to({rotation:-5.2,x:899.7,y:195.7,startPosition:362},9).to({startPosition:370},8).to({y:202.1,startPosition:376},6).to({rotation:3.2,y:195.8,startPosition:381},5).wait(36).to({startPosition:3},0).to({rotation:-5.2,y:195.7,startPosition:13},10).wait(50));

	// Layer 5
	this.instance_1 = new lib.bjntjnutujrtfiu("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(890.4,581.2,1,1,0,0,180,894.1,582.3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(190).to({_off:false},0).to({_off:true},90).wait(93).to({_off:false,regX:786.5,regY:239.2,skewX:-1.5,skewY:178.5,x:998,y:238.1},0).wait(104));

	// Layer 4
	this.instance_2 = new lib.HANDcopy2("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(785,597.6,1,1,0,0,180,25.6,49.7);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(190).to({_off:false},0).wait(90).to({x:781},0).to({startPosition:0},33).to({regY:49.8,skewX:1.8,skewY:181.8,x:779.5,y:598.2},5).to({regY:49.7,skewX:4.2,skewY:184.2,x:777.3,y:598.7},7).to({regX:25.5,regY:49.8,skewX:4.1,skewY:184.1,x:777.4,y:598.9},28).to({regX:25.6,regY:49.7,skewX:4.2,skewY:184.2,x:777.3,y:598.7},9).wait(115));

	// LEFT ARM
	this.instance_3 = new lib.LEFTARMcopy2("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(767.3,482.2,1,1,0,0,180,22.5,88.7);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(190).to({_off:false},0).wait(90).to({regX:22.4,regY:0.1,skewX:1,skewY:181,x:766.4,y:393.6},0).to({startPosition:0},33).to({skewX:0.8,skewY:180.8,x:766.5,y:393.7},5).to({skewX:1,skewY:181,x:766.4,y:393.6},7).to({startPosition:0},28).to({startPosition:0},9).wait(115));

	// LEFT SHOULDER
	this.instance_4 = new lib.LEFTSHOULDERcopy2("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(775.6,332.6,1,1,0,0,180,31.2,95.6);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(190).to({_off:false},0).wait(90).to({regX:20.4,regY:3.5,x:785.4,y:240.5},0).to({startPosition:0},33).to({startPosition:0},5).to({startPosition:0},7).to({startPosition:0},28).to({startPosition:0},9).wait(115));

	// Layer 1
	this.instance_5 = new lib.HANDcopy2("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(1005.1,548,1,1,-0.3,0,0,25.7,0.1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(280).to({_off:false},0).to({startPosition:0},33).to({regX:25.8,rotation:-2.8,x:1005.9,y:547.4},5).to({regX:25.7,rotation:-6.4,x:1007,y:546.5},7).to({rotation:-6.3,y:546.6},28).to({rotation:-6.4,y:546.5},9).to({_off:true},11).wait(104));

	// Layer 2
	this.instance_6 = new lib.LEFTARMcopy2("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(1020.3,393.5,1,1,0,0,0,22.5,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(280).to({_off:false},0).to({startPosition:0},33).to({regY:0.1,rotation:-0.3,x:1020.5,y:393},5).to({rotation:-0.9,x:1020.9,y:392},7).to({regX:22.6,rotation:-0.8,x:1021},28).to({regX:22.5,rotation:-0.9,x:1020.9},9).to({_off:true},11).wait(104));

	// Layer 3
	this.instance_7 = new lib.LEFTSHOULDERcopy2("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(999.9,239.5,1,1,0,0,0,19.4,2.5);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(280).to({_off:false},0).to({startPosition:0},33).to({regY:2.6,rotation:-0.3,x:999.1,y:239.1},5).to({regY:2.5,rotation:-0.9,x:998,y:238.3},7).to({regX:19.5,rotation:-0.8,x:998.1},28).to({regX:19.4,rotation:-0.9,x:998},9).to({_off:true},11).wait(104));

	// COLLAR
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("AlQjRQgIgoAEgjAlQjRQAfg4ADg0QgOAAgMADQgjAIgcAWQg7AvgfByQgHAcgGAfQgRCAAtDdQAKgVAJgUQCMkXCTCTQBEBWBgB8QBZh8BDhXQCPiNCIECQAOAaANAfQAujdgSiAQgFgfgIgcQggh5hBguQgagSgegGQgMgDgHgEQAIA4ATA4QAJgogEgjAigBwQiVjAgbiBACgBvQCWi/AaiB");
	this.shape.setTransform(893.6,218.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#2D2D2D").s().p("AG3D2QAliggOiAQgOiChAhkQBBAuAgB5QAIAcAFAgQASB/guDdQgNgegOgbgAnugtQAGggAHgcQAfhyA7gvQhyDUA6E9IgTAoQgtjdARh/gAE1kuQAHAEAMADIANAeQAEAigJApQgTg5gIg3gAlUkJIAMgeQAMgDAOgBQgDA0gfA5QgIgpAEgig");
	this.shape_1.setTransform(893.6,216.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#4A4A4A").s().p("AmGj5QAcgWAigHIgLAeQgEAiAIAoQAbCCCVC/QiTiTiMEYQg6k9ByjUgAChCTQCWjAAaiBQAJgogEgiIgNgfQAeAHAaARQBABkAOCBQAOCBglCgQiIkDiPCPg");
	this.shape_2.setTransform(893.5,215.2);

	this.instance_8 = new lib.Tween16copy("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(893.6,218.7);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},190).to({state:[{t:this.instance_8}]},90).to({state:[{t:this.instance_8}]},33).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_8}]},7).to({state:[{t:this.instance_8}]},28).to({state:[{t:this.instance_8}]},9).wait(115));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(280).to({_off:false},0).to({startPosition:0},33).to({startPosition:0},5).to({startPosition:0},7).to({startPosition:0},28).to({startPosition:0},9).wait(115));

	// ID
	this.instance_9 = new lib.Symbol6copy("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(892.3,219.7,1,1,0,0,0,25.9,-24.7);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(190).to({_off:false},0).to({startPosition:0},5).to({rotation:1,x:892.4},4).to({regY:-24.6,rotation:-0.5,y:219.8},4).to({regY:-24.7,rotation:0,x:892.3,y:219.7},5).to({startPosition:0},72).to({startPosition:0},33).to({startPosition:0},5).to({startPosition:0},7).to({startPosition:0},28).to({startPosition:0},9).wait(115));

	// PATCH
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A4A").s().p("AorkoICGhVIBjg1IA4BhID3FHIC0j0IB/jTIEMDWIotLNg");
	this.shape_3.setTransform(896,252.1);

	this.instance_10 = new lib.Tween18copy("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(896,252.1);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3}]},190).to({state:[{t:this.instance_10}]},90).to({state:[{t:this.instance_10}]},33).to({state:[{t:this.instance_10}]},5).to({state:[{t:this.instance_10}]},7).to({state:[{t:this.instance_10}]},28).to({state:[{t:this.instance_10}]},9).wait(115));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(280).to({_off:false},0).to({startPosition:0},33).to({startPosition:0},5).to({startPosition:0},7).to({startPosition:0},28).to({startPosition:0},9).wait(115));

	// NECK
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(2,1,1).p("AFImfQADATgLAmQgIAxgCAaQgLCGBABtIABAGQABAKABAJQAXDilyFpQljiogfl7QA3hYASh+IAVh+IAUh/QAPhSBPgdQA6gUA3ACQCGABBrAnIAOAFQAMAFALAFADsoCQARAIAOAJQANAJAKAJQAZAYALAfQABAEABAE");
	this.shape_4.setTransform(893.6,207.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#C2894C").s().p("AhSEaIjblSIAVh/QAPhRBMgeIBxgSIBWAGIAjAFQBFAJAzARIAOAEIAXAKIAEACQARAIAOAKQAMAIAKAJQAaAYAKAfIADAIIAAABIAAAJQAAATgIAdIjNGBQgnAfgrAAQgoAAgtgfgAEihnQgJAxgCAaQACgaAJgxQAIgdAAgTIAAgJQAIAfgHAmQgDAigRAdIgHANgAEqigIAAAAg");
	this.shape_5.setTransform(896.6,181.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#DEB17F").s().p("AlvhRQA3hZASh9IAVh/IACAEIDbFTQAtAfAoAAQArAAAngfIDNmCIgSBYIAIgNQgLCGBABtIABAGIACATQAXDjlyFoQljiogfl6g");
	this.shape_6.setTransform(893.6,218);

	this.instance_11 = new lib.Tween17copy("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(893.6,207.3);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},190).to({state:[{t:this.instance_11}]},90).to({state:[{t:this.instance_11}]},33).to({state:[{t:this.instance_11}]},5).to({state:[{t:this.instance_11}]},7).to({state:[{t:this.instance_11}]},28).to({state:[{t:this.instance_11}]},9).wait(115));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(280).to({_off:false},0).to({startPosition:0},33).to({startPosition:0},5).to({startPosition:0},7).to({startPosition:0},28).to({startPosition:0},9).wait(115));

	// BODY
	this.instance_12 = new lib.BODYcopy("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(893.6,577.2,1,1,0,0,0,120.2,385.5);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(190).to({_off:false},0).to({startPosition:0},5).to({y:575.6},7).to({y:577.2},10).to({startPosition:0},68).to({startPosition:0},33).to({startPosition:0},5).to({startPosition:0},7).to({startPosition:0},28).to({startPosition:0},9).wait(115));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = null;


(lib.Wholeguycopy2 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(474));

	// Layer 22
	this.instance = new lib.Symbol9copy2("synched",190);
	this.instance.parent = this;
	this.instance.setTransform(893,581.2,1,1,0,0,0,894.1,582.3);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(190).to({_off:false},0).to({startPosition:195},5).to({startPosition:197},2).to({scaleY:0.99,startPosition:201},4).to({regY:582.2,scaleY:1.01,skewX:-1.8,skewY:-1,x:886.6,startPosition:207},6,cjs.Ease.get(1)).to({regX:894,y:581.1,startPosition:208},1).to({regX:894.1,y:581.2,startPosition:234},26).to({regY:582.3,scaleY:0.99,skewX:0,skewY:0,x:893,startPosition:242},8,cjs.Ease.get(1)).to({scaleY:1,startPosition:251},9).to({startPosition:269},18).to({startPosition:314},45).to({y:586,startPosition:318},4).to({rotation:-0.3,x:904.4,y:581.3,startPosition:325},7,cjs.Ease.get(1)).to({startPosition:358},33).to({rotation:0,x:893,y:586,startPosition:366},8,cjs.Ease.get(1)).to({y:581.2,startPosition:373},7,cjs.Ease.get(1)).to({rotation:0.5,x:895.4,y:586.1,startPosition:379},6).to({rotation:1.7,x:899.4,y:581.3,startPosition:389},10).to({startPosition:416},27).to({rotation:-0.3,x:904.4,startPosition:426},10).wait(52));

	// Layer 23
	this.instance_1 = new lib.LEFTTHIGHcopy("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(846.8,801.8,1,1,0,0,180,45,240.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(190).to({_off:false},0).to({startPosition:0},11).to({scaleY:1,skewX:-2.1,x:844.3,y:803.4},6,cjs.Ease.get(1)).to({y:801.8},27).to({scaleY:1,skewX:0,x:846.8},17,cjs.Ease.get(1)).to({startPosition:0},63).to({startPosition:0},4).to({skewX:1.3,x:851.5},7,cjs.Ease.get(1)).to({startPosition:0},33).to({skewX:0,x:846.8},8,cjs.Ease.get(1)).to({startPosition:0},7,cjs.Ease.get(1)).to({scaleY:0.99,skewX:0.5,y:801.9},6).to({scaleY:1,skewX:1.3,y:801.8},10).to({startPosition:0},27).to({x:851.5},10).wait(52));

	// LEFT THIGH
	this.instance_2 = new lib.LEFTTHIGHcopy("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(940.5,801.8,1,1,0,0,0,45,240.4);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(190).to({_off:false},0).to({startPosition:0},11).to({regX:45.1,scaleY:1,skewX:-1.9,x:940.7,y:800.2},6,cjs.Ease.get(1)).to({y:801.8},27).to({regX:45,scaleY:1,skewX:0,x:940.5},17,cjs.Ease.get(1)).to({startPosition:0},63).to({startPosition:0},4).to({regX:45.1,scaleY:1,skewX:1.9,x:944.7},7,cjs.Ease.get(1)).to({startPosition:0},33).to({regX:45,scaleY:1,skewX:0,x:940.5},8,cjs.Ease.get(1)).to({startPosition:0},7,cjs.Ease.get(1)).to({scaleY:0.99,skewX:0.5,y:801.9},6).to({scaleY:1,skewX:1.3,y:801.8},10).to({startPosition:0},27).to({regX:45.1,scaleY:1,skewX:1.9,x:944.7},10).wait(52));

	// Layer 25
	this.instance_3 = new lib.LEFTLEGcopy("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(949.5,1004.7,1,1,0,0,0,36,235.1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(190).to({_off:false},0).to({startPosition:0},124).to({startPosition:0},4).to({skewX:1},7,cjs.Ease.get(1)).to({startPosition:0},33).to({skewX:0},8,cjs.Ease.get(1)).to({startPosition:0},7,cjs.Ease.get(1)).to({startPosition:0},6).to({startPosition:0},10).to({startPosition:0},27).to({skewX:1},10).wait(52));

	// LEG
	this.instance_4 = new lib.LEFTLEGcopy("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(837.5,1004.7,1,1,0,0,180,36,235.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(190).to({_off:false},0).to({startPosition:0},11).to({skewX:-1},6,cjs.Ease.get(1)).to({startPosition:0},27).to({skewX:0},17,cjs.Ease.get(1)).to({startPosition:0},63).to({startPosition:0},4).to({regX:35.9,scaleY:1.01,skewX:1.2},7,cjs.Ease.get(1)).to({startPosition:0},33).to({regX:36,scaleY:1,skewX:0},8,cjs.Ease.get(1)).to({startPosition:0},7,cjs.Ease.get(1)).to({startPosition:0},6).to({startPosition:0},10).to({startPosition:0},27).to({regX:35.9,scaleY:1.01,skewX:1.2},10).wait(52));
	...
	this.instance_19 = new lib.Tween20copy("synched",0);
	...
	// LEFT SHOE
	this.instance_35 = new lib.LEFTSHOEcopy2("synched",0);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(408));

	// Layer 32
	this.instance = new lib.Wholeguycopy2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(247.5,706.5,0.693,0.693,0,0,180,893.8,1052.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(412));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(381.2,364.1,204.8,700.8);
// library properties:
lib.properties = {
