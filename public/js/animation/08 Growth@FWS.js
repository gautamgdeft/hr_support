...
(lib.Symbol6_1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(2,1,1).p("AiFhZIAiAeIAACHIgiAnIAAjMIAAhxIELAAIAABxIgkAeIAACHIAkAnIAABYIkLAAIAAhYACGhZIAADM");
...
(lib.LEFTSHOULDER_1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(2,1,1).p("AhjtPQESCYAqIOIBTIyQgNAGgNAGAElMkQAAgCAAgCQAEgsgDg9IgSkCIgCggAjGHaQDrAhDjhiQAFgCAFgCAkrjRIA+KlQATADAUADIA/F2");
...
(lib.LEFTARM_1 = function(mode,startPosition,loop) {
	...
	this.shape_55.graphics.f("#DEB180").s().p("AhUN2Qh9gOAJihIAEgrQAwjhgVk3QgusJAdipQAuhEBagEQC8gHA2BrQAFAJADAKIACAEIAAABIAAACIgCgHIgIgBQgSG1hZOIIAJACIgaCoQgcCQhnAAIgVgBg");
...
(lib.BODY = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A4A").s().p("");
	this.shape_3.setTransform(121.9,192.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2D2D2D").s().p("");
...
(lib.BODY_1 = function(mode,startPosition,loop) {
	...
	this.shape_5.setTransform(120.2,192.7,1,1,0,0,180);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FF0000").s().p("AgaAbQgLgMAAgPQAAgOALgMQAMgLAOAAQAPAAALALQAMAMAAAOQAAAPgMAMQgLALgPAAQgOAAgMgLgAAYAQQALADAAgLQgEAHgHgDQgHgDgCgFIAEgEIAHgIQAEgFABgEIgEADIgGAIIgIAIIgJgKQgGgIgKAEQgQAGAHAPIACACQARALANgPQAFAIAIABgAgQAHQgGgIAKgHQAJgCAFAHIAHAIQgEAFgFACIgFABQgGAAgFgGg");
	this.shape_6.setTransform(70.6,106.8,1,1,0,0,180);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#2D2D2D").s().p("AOWWNIgDgFIga05QgUoqCSnlIAAgBIAHgVIBij+IAtAAQggCMgzCbQgJAghDEqQg8EFAMHoIAECQQAZJVATHaQgkAlg0AfgAuQWNQgzgfgkglQASnaAZpVIAFiQQALnog7kFQhEkqgIggQgzibggiMIAqAAIBlD+IAGAVIABABQCSHlgUIqIgbU5IgCAFgASo1dQgLBCgQBGIgtABQAkhPAkg6gAxczUgAyHzVQgRhOgMhJIgDggQAiBOApBqg");
	this.shape_7.setTransform(119.9,228.1,1,1,0,0,180);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhXATIAAgIIEHAAIAAAIgAh/ARQgIgBgFgIQgOAPgRgLIgCgCQgHgPAQgGQAKgEAHAIIAJAKIAIgIIAHgIIADgDQgBAEgEAFIgHAHIgEAFQADAFAGADQAHADAFgHQAAAJgIAAIgEgBgAikgHQgKAHAHAIQAGAJAKgEQAGgCAEgFIgHgIQgFgGgHAAIgEABgAhFgMIAAgGIDxAAIAAAGg");
	this.shape_8.setTransform(55.4,106.7,1,1,0,0,180);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#4A4A4A").s().p("");
	this.shape_9.setTransform(120.2,192.7,1,1,0,0,180);
...
(lib.Thalay = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		playSound("GrowthFlatworld");
	}

	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(439));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:10},0).wait(3).to({startPosition:36},0).wait(1).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(1).to({startPosition:0},0).wait(9).to({startPosition:26},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(1).to({startPosition:16},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(3).to({startPosition:16},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(3).to({startPosition:0},0).wait(2).to({startPosition:26},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:16},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(1).to({startPosition:36},0).wait(5).to({startPosition:0},0).wait(7).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(1).to({startPosition:5},0).wait(3).to({startPosition:0},0).wait(3).to({startPosition:36},0).wait(5).to({startPosition:0},0).wait(7).to({startPosition:41},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(4).to({startPosition:0},0).wait(4).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(4).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:21},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:36},0).wait(3).to({startPosition:0},0).wait(7).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:16},0).wait(2).to({startPosition:10},0).wait(3).to({startPosition:0},0).wait(2).to({startPosition:16},0).wait(1).to({startPosition:5},0).wait(3).to({startPosition:36},0).wait(3).to({startPosition:10},0).wait(2).to({startPosition:0},0).wait(3).to({startPosition:5},0).wait(3).to({startPosition:36},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(3).to({startPosition:0},0).wait(4).to({startPosition:16},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:21},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(4).to({startPosition:36},0).wait(2).to({startPosition:16},0).wait(4).to({startPosition:36},0).wait(2).to({startPosition:0},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(5).to({startPosition:36},0).wait(6).to({startPosition:0},0).wait(156));
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(49.1,128.9,0.99,0.99,0,-0.7,179.3,1245.4,201.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(463));

	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape.setTransform(42.3,68);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#C2894C").s().p("AjZgMQA1gIAmAXQhWgIhBAyQAJgtAzgMgAB1gRQAUgaAygBQA8ACAfAtQhKgphXAVg");
	this.shape_1.setTransform(41.9,63.6);
	...
	this.shape_2.setTransform(42.8,69.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(42.3,69);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1,1,1).p("AilA9QAjgGAigMQgNgpgrgFQgRgCgXAEQgRACgPAFQgpAPgRAjQAsAKAsgCAilA9QgOACgPABAjgAGQgFAuAjAMAiYgDQAUApghAXAiMgjQhIgEg0AnADIAiQAogEArgPQgTgbgegNQgUgIgYgCQgQgCgOACQg1AHgNAxQAoANArABADIAiQgBAAgCAAQgKAAgKABADqgZQAIAxgqAKACggjQgSAvAjAXAEHgoQhBgkhJAT");
	this.shape_4.setTransform(42.2,68.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AkaAqQARgjApgPQgFAuAjAMIgPAAQglAAgkgIgAiYgRQArAFANApQgiAMgjAFQAhgWgUgpgABeAHQANgyA1gGQgSAwAjAVQgrAAgogNgADqgoQAeANATAcQgrAOgoAEQAqgKgIgxg");
	this.shape_5.setTransform(42.2,69.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#323232").s().p("AjlgHQAPgFARgDQAXgDARACQAUApghAWIgdAEQgjgMAFgugACbgwQAOgCAQABQAYACAUAIQAIAxgqAKIgDABIgUAAQgjgVASgwg");
	this.shape_6.setTransform(42.7,69.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#C2894C").s().p("AiKAFQhJgEg0AnQAwhBBNAegAB+gRQBOgzA8BEQhAgkhKATg");
	this.shape_7.setTransform(42.1,64.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1,1,1).p("AiUAbQAbADAZAKQgiAMgjAGQgHABgHABQgDAAgDAAIgCAAQgDAAgEABQgsACgsgKQAbgNAfgHAiUAbQgngEglAKAiUgfQg8gGgvAiAi7A8QgfAAgGgbAiUAbQgDAZgcAIACZABQggAFgbAMQAoANArABQAKgBAKAAQACAAABAAQAogEArgPQgCgCgBgCQgagGgUgCQgLAegegBQgfgBgJgbgADqAAQgsgDglAEAD/gnQg6gdg5AL");
	this.shape_8.setTransform(42.2,68.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#323232").s().p("AjAAfQgfAAgFgbQAlgJAmAEQgDAYgcAIIgGAAgAC8AAQgeAAgJgbQAkgFAsAEQgKAcgdAAIgCAAg");
	this.shape_9.setTransform(42.7,71.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AkaAWQAbgNAfgHQAGAbAfAAIgHABIgPABQglAAgkgJgAiUgDQAbADAZAJQgiAMgjAGIgOACQAcgIADgYgABegMQAbgMAggFQAJAbAfABQAeABALgeQAUACAaAGIADAEQgrAPgoADIgDAAIgUABQgrgBgogMg");
	this.shape_10.setTransform(42.2,71.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#C2894C").s().p("AiUAHQg8gFgvAhQAog+BDAigACMgSQBHgnAtA5Qg7gdg5ALg");
	this.shape_11.setTransform(42.2,64.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1,1,1).p("AiggkQgzgBghAXAhnAfQhXA6hKgtQBIAYBZglgAD0guQgpgXg1AIAEJAKQhUA0hSgzQBcAbBKgcg");
	this.shape_12.setTransform(42.4,69.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#2B2B2B").s().p("AkIAHQBIAYBZgkQgxAggtAAQgjAAgggUgABjgZQBcAaBKgbQgqAagqAAQgpAAgpgZg");
	this.shape_13.setTransform(42.4,73.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#C2894C").s().p("AifAJQgzgBghAWQAgg0A0AfgACWgQQA+ghAgAxQgogXg2AHg");
	this.shape_14.setTransform(42.3,65);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1,1,1).p("AiUAbQAbADAZAKQgiAMgjAGQgHABgHABQgDAAgDAAIgCAAQgDAAgEABQgsACgsgKQAbgNAfgHAiUgfQg8gGgvAiAi7A8QgfAAgGgbAiUAbQgDAZgcAIAiUAbQgngEglAKACZABQggAFgbAMQAoANArABQAKgBAKAAQACAAABAAQAogEArgPQgCgCgBgCQgagGgUgCQgLAegegBQgfgBgJgbgAD/gnQg6gdg5ALADqAAQgsgDglAE");
	this.shape_15.setTransform(42.2,68.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_16.setTransform(42.3,68);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#000000").ss(1,1,1).p("AilA9QAjgGAigMQgNgpgrgFQgRgCgXAEQgRACgPAFQgpAPgRAjQAsAKAsgCAilA9QgOACgPABAjgAGQgFAuAjAMAiYgDQAUApghAXAiMgjQhIgEg0AnADIAiQAogEArgPQgTgbgegNQAIAxgqAKQgBAAgCAAQgKAAgKABADqgZQgUgIgYgCQgQgCgOACQg1AHgNAxQAoANArABACggjQgSAvAjAXAEHgoQhBgkhJAT");
	this.shape_17.setTransform(42.2,68.4);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#000000").ss(1,1,1).p("AhnAfQhXA6hKgtQBIAYBZglgAiggkQgzgBghAXAEJAKQhUA0hSgzQBcAbBKgcgAD0guQgpgXg1AI");
	this.shape_18.setTransform(42.4,69.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#000000").ss(1,1,1).p("AilA9QAjgGAigMQgNgpgrgFQgRgCgXAEQgRACgPAFQgpAPgRAjQAsAKAsgCAilA9QgOACgPABAiMgjQhIgEg0AnAjgAGQgFAuAjAMAiYgDQAUApghAXADIAiQAogEArgPQgTgbgegNQAIAxgqAKQgBAAgCAAQgKAAgKABADqgZQgUgIgYgCQgQgCgOACQgSAvAjAXACggjQg1AHgNAxQAoANArABAEHgoQhBgkhJAT");
	this.shape_19.setTransform(42.2,68.4);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#000000").ss(1,1,1).p("AiUAbQAbADAZAKQgiAMgjAGQgHABgHABQgDAAgDAAIgCAAQgDAAgEABQgsACgsgKQAbgNAfgHAiUAbQgDAZgcAIAi7A8QgfAAgGgbAiUgfQg8gGgvAiAiUAbQgngEglAKACZABQggAFgbAMQAoANArABQAKgBAKAAQACAAABAAQAogEArgPQgCgCgBgCQgagGgUgCQgLAegegBQgfgBgJgbgAD/gnQg6gdg5ALADqAAQgsgDglAE");
	this.shape_20.setTransform(42.2,68.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#000000").ss(1,1,1).p("AiUAbQAbADAZAKQgiAMgjAGQgHABgHABQgDAAgDAAIgCAAQgDAAgEABQgsACgsgKQAbgNAfgHAiUAbQgngEglAKAiUAbQgDAZgcAIAi7A8QgfAAgGgbAiUgfQg8gGgvAiACZABQggAFgbAMQAoANArABQAKgBAKAAQACAAABAAQAogEArgPQgCgCgBgCQgagGgUgCQgLAegegBQgfgBgJgbgADqAAQgsgDglAEAD/gnQg6gdg5AL");
	this.shape_21.setTransform(42.2,68.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#000000").ss(1,1,1).p("AilA9QAjgGAigMQgNgpgrgFQgRgCgXAEQgRACgPAFQgpAPgRAjQAsAKAsgCAilA9QgOACgPABAiMgjQhIgEg0AnAjgAGQgFAuAjAMAiYgDQAUApghAXADIAiQAogEArgPQgTgbgegNQgUgIgYgCQgQgCgOACQgSAvAjAXADIAiQgBAAgCAAQgKAAgKABADqgZQAIAxgqAKACggjQg1AHgNAxQAoANArABAEHgoQhBgkhJAT");
	this.shape_22.setTransform(42.2,68.4);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_23.setTransform(42.3,68);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_24.setTransform(42.3,68);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#000000").ss(1,1,1).p("AilA9QAjgGAigMQgNgpgrgFQgRgCgXAEQgRACgPAFQgpAPgRAjQAsAKAsgCAilA9QgOACgPABAiYgDQAUApghAXAjgAGQgFAuAjAMAiMgjQhIgEg0AnADIAiQAogEArgPQgTgbgegNQAIAxgqAKQgBAAgCAAQgKAAgKABADqgZQgUgIgYgCQgQgCgOACQg1AHgNAxQAoANArABACggjQgSAvAjAXAEHgoQhBgkhJAT");
	this.shape_25.setTransform(42.2,68.4);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f().s("#000000").ss(1,1,1).p("AilA9QAjgGAigMQgNgpgrgFQgRgCgXAEQgRACgPAFQgpAPgRAjQAsAKAsgCAilA9QgOACgPABAiYgDQAUApghAXAjgAGQgFAuAjAMAiMgjQhIgEg0AnADIAiQAogEArgPQgTgbgegNQgUgIgYgCQgQgCgOACQg1AHgNAxQAoANArABADIAiQgBAAgCAAQgKAAgKABADqgZQAIAxgqAKACggjQgSAvAjAXAEHgoQhBgkhJAT");
	this.shape_26.setTransform(42.2,68.4);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#000000").ss(1,1,1).p("AilA9QAjgGAigMQgNgpgrgFQgRgCgXAEQgRACgPAFQgpAPgRAjQAsAKAsgCAilA9QgOACgPABAiMgjQhIgEg0AnAiYgDQAUApghAXAjgAGQgFAuAjAMADIAiQAogEArgPQgTgbgegNQAIAxgqAKQgBAAgCAAQgKAAgKABADqgZQgUgIgYgCQgQgCgOACQgSAvAjAXACggjQg1AHgNAxQAoANArABAEHgoQhBgkhJAT");
	this.shape_27.setTransform(42.2,68.4);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f().s("#000000").ss(1,1,1).p("AilA9QAjgGAigMQgNgpgrgFQgRgCgXAEQgRACgPAFQgpAPgRAjQAsAKAsgCAilA9QgOACgPABAiMgjQhIgEg0AnAiYgDQAUApghAXAjgAGQgFAuAjAMADIAiQAogEArgPQgTgbgegNQgUgIgYgCQgQgCgOACQgSAvAjAXADIAiQgBAAgCAAQgKAAgKABADqgZQAIAxgqAKACggjQg1AHgNAxQAoANArABAEHgoQhBgkhJAT");
	this.shape_28.setTransform(42.2,68.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},12).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_15}]},2).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},9).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_17}]},23).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_18}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_2},{t:this.shape_3},{t:this.shape_1},{t:this.shape}]},8).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_19}]},77).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_20}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_21}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_22}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape_23}]},1).to({state:[{t:this.shape_2},{t:this.shape_3},{t:this.shape_1},{t:this.shape_24}]},8).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_25}]},17).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_18}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_26}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_2},{t:this.shape_3},{t:this.shape_1},{t:this.shape}]},8).to({state:[{t:this.shape_2},{t:this.shape_3},{t:this.shape_1},{t:this.shape_16}]},2).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_27}]},62).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_20}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_21}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_28}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape_23}]},1).to({state:[{t:this.shape_2},{t:this.shape_3},{t:this.shape_1},{t:this.shape_24}]},8).to({state:[{t:this.shape_2},{t:this.shape_3},{t:this.shape_1},{t:this.shape_23}]},2).wait(197));

	// Layer 3
	this.instance_1 = new lib.Twefn1y("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(43.9,54.4,1,1,0,4.4,-175.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},12).to({x:43.8,y:55.2},2).to({x:43.9,y:54.2},3).to({y:54.4},4).to({startPosition:0},6).to({startPosition:0},22).to({y:54.2},1).to({x:43.8,y:55.2},3).to({x:43.9,y:54.4},2).to({startPosition:0},8).to({startPosition:0},5).to({skewX:4.5,skewY:-175.5},1).to({regX:0.1,regY:0.1,skewX:4.3,skewY:-175.7,x:43.7,y:54.5},9).to({scaleX:1,scaleY:1,x:43.6,y:55.8},2).to({regY:0.2,x:43.5,y:52.1},9,cjs.Ease.get(1)).to({startPosition:0},9,cjs.Ease.get(1)).to({regX:0,regY:0,scaleX:1,scaleY:1,skewX:4.4,skewY:-175.6,x:43.9,y:54.4},6,cjs.Ease.get(1)).to({startPosition:0},18).to({startPosition:0},8).to({x:43.8,y:55.2},2).to({x:43.9,y:54.2},3).to({y:54.4},4).to({startPosition:0},6).to({regX:0.1,regY:0.1,skewX:4.3,skewY:-175.7,x:43.8,y:54.9},3).to({y:51.8},5).to({regX:0,regY:0,skewX:4.4,skewY:-175.6,x:43.9,y:54.2},6).to({startPosition:0},11).to({x:43.8,y:55.2},3).to({x:43.9,y:54.4},2).to({startPosition:0},8).to({startPosition:0},5).to({skewX:4.5,skewY:-175.5},1).to({skewX:4.4,skewY:-175.6,y:54.2},60).to({x:43.8,y:55.2},3).to({x:43.9,y:54.4},2).to({startPosition:0},8).to({startPosition:0},5).to({skewX:4.5,skewY:-175.5},1).wait(195));

	// Layer 1
	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("#000000").ss(1,1,1).p("AGrBiQgdAEggCAIgclcIANiyQgTgNgUgMQirhekTAzQiagch5BRIgQDNIgfEUAHnC5QgJgLgIgHQg4gzgBBnQAAAeAWAQQAfARgtAkQgwAlAhAUAjliLQBLAnABBhQgEB1gTBxQAGAQBQAjAnmDRQAWgqAEBMQABAYABARQADASACAMQADAQAFAGQAbA8gcgQAgfEMQgJgLgpgG");
	this.shape_29.setTransform(52.7,68.9);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("#000000").ss(2,1,1).p("AmUFuIAOBMQASBBAeAdQAoA5AvAyQA8A+BHA0IB6AAQBLgvA4glQAlgXAcgVQBHg1ALgbIA7iiIAMghQCOAsAfjcQAUiEhugGIAKh9IATj5QAgAPAmArQgblhmVhiQnchoh+EMQgXBJA5BYQhIAxATBZIAhCxIAiCwQg5ATAPBOIAnCPQALApAtgEgAnJBZIAFAXIAwD+");
	this.shape_30.setTransform(52.4,74.7);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.lf(["#323232","#DEB17F"],[0.004,1],-0.3,-6,-1.5,7.1).s().p("AAABzIghiwIBDhNIgeEVg");
	this.shape_31.setTransform(6.7,72.1);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.lf(["#323232","#DEB17F"],[0.004,1],0.1,-9.9,-2.9,9.2).s().p("AgwiuIBiBcIgKB8QgdAFgeB/g");
	this.shape_32.setTransform(91.4,74.5);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#C2894C").s().p("AD1GSQBSlSgXkUQgEgogFgnIAXjVQAUAMATANIgOCyIAdFcIgiDYIg7CiQgLAahIA1QAhgiAQhEgAm4DFQgWhDAPABQADAQAFAGQAVAwgNAAQgDAAgGgEgAGcDBQghgVAwglQAtgkgggQQgVgRgBgeQAChmA4A0QASBPgoBgQgOAhgTAAQgEAAgFgBgAngAaQAWgpAEBLIACAqQgDADgDAAQgOAAgIhPgAg0AZIAQgmIAjBFQgSgeghgBg");
	this.shape_33.setTransform(52.1,87.2);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#323232").s().p("AFVD0IANixQgTgOgUgLQiqhdkUAyQiZgch6BQIgQDNIhFBNIghixQgThYBIgyQg5hWAXhKQB+kLHcBnQGVBjAbFfQgmgrgggOIgTD5g");
	this.shape_34.setTransform(52.4,32.6);
	...
	this.shape_35.setTransform(53.4,90.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29}]}).wait(463));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.5,-2,107.8,153.5);
...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	// HEAD
	this.instance = new lib.Symbol2("synched",110);
	this.instance.parent = this;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(130).to({_off:false},0).to({startPosition:0},5).to({y:575.6},7).to({y:577.2},10).to({startPosition:0},50).to({_off:true},262).wait(284));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(843.8,42.6,107.8,153.5);
...
(lib.Wholeguy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(130).to({_off:false},0).to({startPosition:137},7).to({scaleY:0.99,startPosition:141},4).to({regY:582.2,scaleY:1.01,skewX:-1.8,skewY:-1,x:886.6,startPosition:147},6,cjs.Ease.get(1)).to({startPosition:174},27).to({regY:582.3,scaleY:0.99,skewX:0,skewY:0,x:893,startPosition:182},8,cjs.Ease.get(1)).to({scaleY:1,startPosition:191},9).to({startPosition:298},107).wait(166));
...
// stage content:
(lib._08GrowthFWS = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(295));

	// Layer 2
	this.instance = new lib.Wholeguy("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(248.6,707.2,0.694,0.694,0,0,180,893.9,1052.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(299));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(380.1,363.7,207.3,701.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"/sounds/growth/GrowthFlatworld.mp3", id:"GrowthFlatworld"}
	],
	preloads: []
};
