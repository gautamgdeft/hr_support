...
(lib.Tween9 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#DEB17F").s().p("AlvhRQA3hZASh9IAVh/IACAEIDbFTQAtAfAoAAQArAAAngfIDNmCIgSBYIAIgNQgLCGBABtIABAGIACATQAXDjlyFoQljiogfl6g");
	this.shape_1.setTransform(0,10.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#C2894C").s().p("AhSEaIjblSIAVh/QAPhRBMgeIBxgSIBWAGIAjAFQBFAJAzARIAOAEIAXAKIAEACQARAIAOAKQAMAIAKAJQAaAYAKAfIADAIIAAABQAIAfgHAmQgDAigRAdQACgaAJgxQAIgdAAgTIAAgJIAAAJQAAATgIAdQgJAxgCAaIgHANIAShYIjNGBQgnAfgrAAQgoAAgtgfg");
...
(lib.HAND = function(mode,startPosition,loop) {
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#DEB180").s().p("");
	this.shape_11.setTransform(36.9,60);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(2,1,1).p("");
	this.shape_12.setTransform(36.9,61.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#C2894C").s().p("");
	this.shape_13.setTransform(22.9,81.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#DEB180").s().p("");
...
(lib.BODY_1 = function(mode,startPosition,loop) {
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#2D2D2D").s().p("AOWWNIgDgFIga05QgUoqCSnlIAAgBIAHgVIBij+QAkhPAkg6QgLBCgQBGIgtABIAtAAQggCMgzCbQgJAghDEqQg8EFAMHoIAECQQAZJVATHaQgkAlg0AfgAuQWNQgzgfgkglQASnaAZpVIAFiQQALnog7kFQhEkqgIggQgzibggiMIAqAAIBlD+IAGAVIABABQCSHlgUIqIgbU5IgCAFgAxczUgAyHzVQgRhOgMhJIgDggQAiBOApBqg");
...
(lib.Thalay = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		playSound("DialupFlatworld");
	}

	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(468));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({startPosition:31},0).wait(2).to({startPosition:16},0).wait(3).to({startPosition:0},0).wait(5).to({startPosition:26},0).wait(3).to({startPosition:10},0).wait(3).to({startPosition:31},0).wait(7).to({startPosition:31},0).wait(3).to({startPosition:5},0).wait(3).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(3).to({startPosition:31},0).wait(3).to({startPosition:5},0).wait(3).to({startPosition:31},0).wait(3).to({startPosition:0},0).wait(2).to({startPosition:26},0).wait(4).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:21},0).wait(3).to({startPosition:10},0).wait(4).to({startPosition:26},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:31},0).wait(2).to({startPosition:5},0).wait(3).to({startPosition:0},0).wait(3).to({startPosition:10},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(4).to({startPosition:10},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:36},0).wait(4).to({startPosition:0},0).wait(12).to({startPosition:41},0).wait(3).to({startPosition:10},0).wait(3).to({startPosition:26},0).wait(5).to({startPosition:31},0).wait(3).to({startPosition:10},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(4).to({startPosition:16},0).wait(3).to({startPosition:26},0).wait(3).to({startPosition:5},0).wait(3).to({startPosition:31},0).wait(4).to({startPosition:36},0).wait(4).to({startPosition:0},0).wait(4).to({startPosition:16},0).wait(3).to({startPosition:26},0).wait(3).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(10).to({startPosition:21},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:41},0).wait(3).to({startPosition:10},0).wait(3).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(3).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(3).to({startPosition:31},0).wait(2).to({startPosition:5},0).wait(5).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(3).to({startPosition:41},0).wait(3).to({startPosition:0},0).wait(7).to({startPosition:10},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:26},0).wait(4).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:0},0).wait(3).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(3).to({startPosition:31},0).wait(3).to({startPosition:5},0).wait(4).to({startPosition:31},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(3).to({startPosition:41},0).wait(4).to({startPosition:5},0).wait(4).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:5},0).wait(6).to({startPosition:0},0).wait(6).to({startPosition:36},0).wait(3).to({startPosition:26},0).wait(3).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(5).to({startPosition:5},0).wait(3).to({startPosition:41},0).wait(3).to({startPosition:26},0).wait(3).to({startPosition:36},0).wait(4).to({startPosition:41},0).wait(3).to({startPosition:36},0).wait(3).to({startPosition:0},0).wait(4).to({startPosition:26},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:36},0).wait(5).to({startPosition:0},0).wait(7).to({startPosition:10},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:16},0).wait(2).to({startPosition:0},0).wait(3).to({startPosition:41},0).wait(3).to({startPosition:26},0).wait(3).to({startPosition:41},0).wait(3).to({startPosition:36},0).wait(6).to({startPosition:0},0).wait(88));
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjpgZQAUgIAYgCQAQgCAOACQA1AHANAxQgoANgrABAjpgZQgIAxAqAKQABAAACAAQAKAAAKABAjHAiQgogEgrgPQATgbAegNACZgDQARgCAXAEQARACAPAFQAFAugjAMAifgjQASAvgjAXACmA9QAOACAPABACmA9QgjgGgigMQANgpArgFQgUApAhAXgAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_20.setTransform(59.4,68.4);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAjpAAQALAeAegBQAfgBAJgbQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQAsgDAlAEACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALACVAbQAngEAlAKACVgfQA8gGAvAi");
	this.shape_21.setTransform(59.4,68.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAjpAAQALAeAegBQAfgBAJgbQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQAsgDAlAEACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALACVgfQA8gGAvAiACVAbQAngEAlAK");
	this.shape_22.setTransform(59.4,68.7);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjpgZQgIAxAqAKQABAAACAAQAKAAAKABAjpgZQAUgIAYgCQAQgCAOACQA1AHANAxQgoANgrABAjHAiQgogEgrgPQATgbAegNACZgDQARgCAXAEQARACAPAFQAFAugjAMAifgjQASAvgjAXACmA9QAOACAPABACmA9QgjgGgigMQANgpArgFQgUApAhAXgAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_23.setTransform(59.4,68.4);
	...
	this.shape_24.setTransform(59.3,68);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_25.setTransform(59.4,68.4);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("");
	this.shape_26.setTransform(59.4,69.9);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#323232").s().p("");
	this.shape_27.setTransform(58.9,69.8);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_28.setTransform(59.4,68.7);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("");
	this.shape_29.setTransform(59.4,71.8);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#323232").s().p("AC/AfIgGAAIgFgCIARACIgFAAgAC0AdQgYgJgCgVQAlgEAkAIQgFAOgMAIIgFAFIAFgFQAMgIAFgOIACABQgEAVgUAFIgIABgAC0AdgAjkgcQArgEAkAFQgDAIgGAIIgFAFIAFgFQAGgIADgIIABAAQgEAOgLAHQgKAGgOAAIgCAAQgdAAgKgcg");
	this.shape_30.setTransform(58.9,71.6);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_31.setTransform(59.3,68);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},12).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_15}]},2).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},9).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_18}]},23).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_19}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_17},{t:this.shape_3},{t:this.shape_1},{t:this.shape}]},8).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_20}]},80).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_21}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_22}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_23}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_24}]},1).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_7},{t:this.shape_25}]},24).to({state:[{t:this.shape_11},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_22}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_23}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_24}]},1).to({state:[{t:this.shape_17},{t:this.shape_3},{t:this.shape_1},{t:this.shape_31}]},8).wait(275));
	...
	// Layer 1
	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("#000000").ss(1,1,1).p("AHnDRQgXgqgDBMQgBAYgBARQgDASgCAMQgDAQgFAGQgbA8AcgQAmqBiQAdAEAfCAIAdlcIgNiyQATgNAUgMQCqheEUAzQCagcB5BRIAQDNIAfEUAnmC5QAJgLAIgHQA4gzABBnQAAAegVAQQggARAtAkQAwAlgiAUADliLQhLAnAABhQAEB1ATBxQgGAQhQAjAAgEMQAJgLAogG");
	this.shape_32.setTransform(48.9,68.9);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("#000000").ss(2,1,1).p("AGVFuIgOBMQgSBBgeAdQgoA5gvAyQg8A+hHA0Ih6AAQhLgvg4glQglgXgcgVQhHg1gLgbIg7iiIgMghQiOAsgfjcQgUiEBugGIgKh9IgTj5QggAPgmArQAblhGVhiQHchoB+EMQAXBJg5BYQBIAxgTBZIghCxIgiCwQA5ATgPBOIgnCPQgLApgtgEgAHKBZIgFAXIgwD+");
	this.shape_33.setTransform(49.2,74.7);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.lf(["#323232","#DEB17F"],[0.004,1],0,-9.9,3,9.2).s().p("AgnAqIgKh8IBihcIgdFcQgeh/gdgFg");
	this.shape_34.setTransform(10.2,74.5);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.lf(["#323232","#DEB17F"],[0.004,1],0.3,-6,1.5,7.1).s().p("AghiKIBDBNIghCwIgEAYg");
	this.shape_35.setTransform(95,72.1);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#C2894C").s().p("AkWGpIg7iiIgijYIAdlcIgOiyQATgNAUgMIAXDVQgFAngEAoQgXEUBSFSQAQBEAhAiQhIg1gLgagAG4CZQAFgGADgQQAPgBgWBDQgGAEgDAAQgNAAAVgwgAnFChQgohgAShPQA4g0ACBmQgBAegVARQggAQAtAkQAwAlghAVQgFABgEAAQgTAAgOghgAHFBmIACgqQAEhLAWApQgIBPgOAAQgDAAgDgDgAAlgNIAQAmQghABgSAeg");
	this.shape_36.setTransform(49.5,87.2);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#323232").s().p("AnKBXQggAOgmArQAblfGVhjQHchnB+ELQAXBKg5BWQBIAygTBYIghCxIhFhNIgQjNQh6hQiZAcQkUgyiqBdQgUALgTAOIANCxIhjBcg");
	this.shape_37.setTransform(49.2,32.6);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#DEB17F").s().p("");
	this.shape_38.setTransform(48.2,90.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32}]}).wait(463));
...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:20},20).to({regX:54.3,rotation:-4.5,x:899.6,startPosition:28},8,cjs.Ease.get(0.99)).to({regX:54.4,rotation:-4.3,x:899.7,startPosition:49},21).to({regX:54.3,rotation:-4.5,x:899.6,startPosition:59},10).to({regX:54.2,rotation:0,x:899.5,startPosition:66},7,cjs.Ease.get(1)).to({startPosition:98},32).to({y:196.1,startPosition:100},2).to({y:193.7,startPosition:105},5,cjs.Ease.get(1)).to({rotation:1.5,x:899.6,y:195.7,startPosition:110},5,cjs.Ease.get(1)).to({startPosition:142},32).to({regX:54.4,rotation:-1.5,x:899.8,startPosition:150},8,cjs.Ease.get(1)).to({startPosition:183},33).wait(48).to({startPosition:231},0).to({regX:54.3,regY:151.2,rotation:3,x:899.7,startPosition:240},9).wait(63).to({startPosition:303},0).to({regX:54.4,regY:151.1,rotation:-1.5,x:899.8,startPosition:314},11).wait(39).to({startPosition:353},0).to({rotation:4.5,x:902.1,startPosition:361},8).to({startPosition:373},12).to({rotation:-1.5,x:899.8,startPosition:381},8).wait(26));

	// Layer 8
	this.instance_1 = new lib.Tween6_1("synched",4);
	this.instance_1.parent = this;
	this.instance_1.setTransform(784.2,240.8,1,1,-1.2,0,0,6.6,-202);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(347).to({_off:false},0).to({regX:6.7,rotation:7,x:784.3,startPosition:15},11).to({rotation:7,startPosition:36},21).to({regX:6.6,rotation:-0.7,startPosition:48},12).wait(16));

	// Layer 7
	this.instance_2 = new lib.Tween7_1("synched",4);
	this.instance_2.parent = this;
	this.instance_2.setTransform(1002.9,241.2,1,1,1,0,0,-7,-201.3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(347).to({_off:false},0).to({rotation:-9.5,startPosition:15},11).to({startPosition:36},21).to({rotation:0.2,startPosition:48},12).wait(16));

	// Layer 1
	this.instance_3 = new lib.HAND_1("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(1004,547.9,1,1,0,0,0,25.6,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(130).to({_off:false},0).to({startPosition:0},4).to({regY:0.1,rotation:0.9,x:1007.6,y:548},8,cjs.Ease.get(1)).to({regX:25.7,regY:0,rotation:0,x:1001.7,y:547.9},9,cjs.Ease.get(1)).to({regX:25.6,rotation:-1.5,x:1004},11,cjs.Ease.get(1)).to({rotation:0},13,cjs.Ease.get(1)).to({startPosition:0},6).to({startPosition:0},4).to({regY:0.1,rotation:0.9,x:1007.6,y:548},8,cjs.Ease.get(1)).to({regX:25.7,regY:0,rotation:0,x:1001.7,y:547.9},9,cjs.Ease.get(1)).to({regX:25.6,rotation:-1.5,x:1004},11,cjs.Ease.get(1)).to({rotation:0},13,cjs.Ease.get(1)).to({startPosition:0},112).to({x:996.7},8).to({_off:true},1).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(130).to({_off:false},0).to({startPosition:0},4).to({regY:0.1,rotation:-1.2,x:1021.6,y:393.6},8,cjs.Ease.get(1)).to({rotation:0.9},9,cjs.Ease.get(1)).to({regY:0,rotation:0,x:1021.5,y:393.5},11,cjs.Ease.get(1)).to({startPosition:0},19).to({startPosition:0},4).to({regY:0.1,rotation:-1.2,x:1021.6,y:393.6},8,cjs.Ease.get(1)).to({rotation:0.9},9,cjs.Ease.get(1)).to({regY:0,rotation:0,x:1021.5,y:393.5},11,cjs.Ease.get(1)).to({startPosition:0},125).to({rotation:1.2,x:1017.5},8).to({_off:true},1).wait(60));

	// Layer 4
	this.instance_5 = new lib.HAND_1("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(785,597.6,1,1,0,0,180,25.6,49.7);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(657,391.9,1,1,5,0,0,46.8,18.2);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_5}]},130).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]},1).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},9).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_15}]},16).to({state:[{t:this.shape_17},{t:this.shape_10},{t:this.shape_16}]},1).to({state:[{t:this.shape_18},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19}]},1).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},6).to({state:[{t:this.instance_5}]},14).to({state:[{t:this.instance_5}]},12).to({state:[{t:this.instance_5}]},124).to({state:[{t:this.instance_5}]},8).to({state:[]},1).wait(60));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(130).to({_off:false},0).wait(1).to({x:779.5},0).wait(1).to({x:774.5,y:597.4},0).to({_off:true},1).wait(47).to({_off:false},0).wait(1).to({x:779.5,y:597.6},0).wait(1).to({x:784},0).to({x:776},6,cjs.Ease.get(0.7)).to({x:784},14,cjs.Ease.get(1)).to({x:781},12,cjs.Ease.get(1)).to({startPosition:0},124).to({x:792.6},8).to({_off:true},1).wait(60));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(138).to({_off:false},0).to({regX:46.9,rotation:-9.7,x:653,y:413.2},9,cjs.Ease.get(0.85)).to({regX:47,regY:18.3,rotation:-20.1,x:654.8,y:415.8},6,cjs.Ease.get(1)).to({regX:47.1,regY:18.4,rotation:-24.4,x:655,y:415.9},6,cjs.Ease.get(1)).to({_off:true},16).wait(232));

	// LEFT ARM
	this.instance_7 = new lib.LEFTARM_1("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(767.3,482.2,1,1,0,0,180,22.5,88.7);
	this.instance_7._off = true;

	this.instance_8 = new lib.LEFTARM_1("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(1021.5,482.2,1,1,0,0,0,22.5,88.7);
	...
	this.instance_9 = new lib.Tween4_1("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(757.8,377.7,1,1,0,0,0,55.9,-27.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.Symbol7("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(721,431.8,1,1,0,0,0,52.8,51);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7}]},130).to({state:[{t:this.instance_8},{t:this.instance_7}]},1).to({state:[{t:this.instance_8},{t:this.instance_7}]},1).to({state:[{t:this.instance_8},{t:this.instance_7}]},1).to({state:[{t:this.shape_23},{t:this.shape_22}]},1).to({state:[{t:this.shape_25},{t:this.shape_24}]},1).to({state:[{t:this.shape_27},{t:this.shape_26}]},1).to({state:[{t:this.shape_29},{t:this.shape_28}]},1).to({state:[{t:this.shape_31},{t:this.shape_30}]},1).to({state:[{t:this.shape_33},{t:this.shape_32}]},1).to({state:[{t:this.shape_35},{t:this.shape_34}]},1).to({state:[{t:this.shape_37},{t:this.shape_36}]},1).to({state:[{t:this.shape_39},{t:this.shape_38}]},1).to({state:[{t:this.shape_41},{t:this.shape_40}]},1).to({state:[{t:this.shape_43},{t:this.shape_42}]},1).to({state:[{t:this.shape_45},{t:this.shape_44}]},1).to({state:[{t:this.shape_47},{t:this.shape_46}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},6).to({state:[{t:this.shape_29},{t:this.shape_28}]},22).to({state:[{t:this.shape_26},{t:this.instance_10}]},1).to({state:[{t:this.shape_25},{t:this.shape_24}]},1).to({state:[{t:this.shape_23},{t:this.shape_22}]},1).to({state:[{t:this.instance_8},{t:this.instance_7}]},1).to({state:[{t:this.instance_8},{t:this.instance_7}]},1).to({state:[{t:this.instance_8},{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},6).to({state:[{t:this.instance_7}]},14).to({state:[{t:this.instance_7}]},12).to({state:[{t:this.instance_7}]},124).to({state:[{t:this.instance_7}]},8).to({state:[]},1).wait(60));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(130).to({_off:false},0).wait(1).to({regX:22.4,regY:0.1,skewX:1.5,skewY:181.5,x:766.4,y:393.6},0).wait(1).to({regX:22.5,skewX:3.2,skewY:183.2,x:766.3},0).wait(1).to({regY:0,skewX:6.2,skewY:186.2,x:766.4,y:392.5},0).to({_off:true},1).wait(45).to({_off:false},0).wait(1).to({regY:0.1,skewX:3.2,skewY:183.2,x:766.3,y:393.6},0).wait(1).to({regX:22.4,skewX:1.5,skewY:181.5,x:766.4},0).wait(1).to({regX:22.5,regY:0,skewX:0,skewY:180,x:766.3,y:393.5},0).to({regX:22.4,skewX:2.7,skewY:182.7,x:766.4,y:393.6},6,cjs.Ease.get(0.7)).to({regX:22.5,skewX:0,skewY:180,x:766.3,y:393.5},14,cjs.Ease.get(1)).to({regX:22.4,regY:0.1,skewX:1,skewY:181,x:766.4,y:393.6},12,cjs.Ease.get(1)).to({startPosition:0},124).to({skewX:-1.2,skewY:178.8,x:771.2},8).to({_off:true},1).wait(60));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(147).to({_off:false},0).to({rotation:-2.2},6,cjs.Ease.get(1)).to({_off:true},22).wait(232));
...
(lib.Wholeguy = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(396));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(130).to({_off:false},0).to({startPosition:137},7).to({scaleY:0.99,startPosition:141},4).to({regY:582.2,scaleY:1.01,skewX:-1.8,skewY:-1,x:886.6,startPosition:147},6,cjs.Ease.get(1)).to({startPosition:174},27).to({regY:582.3,scaleY:0.99,skewX:0,skewY:0,x:893,startPosition:182},8,cjs.Ease.get(1)).to({scaleY:0.99,startPosition:183},1).to({scaleY:1,startPosition:191},8).to({startPosition:231},40).to({regY:582.4,scaleY:0.99,y:583.4,startPosition:236},5).to({regX:894.2,regY:582.2,scaleY:1,rotation:0.8,y:581.2,startPosition:244},8).to({startPosition:302},58).to({rotation:-0.2,startPosition:312},10).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(130).to({_off:false},0).to({startPosition:0},11).to({scaleY:1,skewX:-2.1,x:844.3,y:803.4},6,cjs.Ease.get(1)).to({y:801.8},27).to({scaleY:1,skewX:0,x:846.8},17,cjs.Ease.get(1)).to({startPosition:0},40).to({startPosition:0},5).to({startPosition:0},8).to({startPosition:0},58).to({startPosition:0},10).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(130).to({_off:false},0).to({startPosition:0},11).to({regX:45.1,scaleY:1,skewX:-1.9,x:940.7,y:800.2},6,cjs.Ease.get(1)).to({y:801.8},27).to({regX:45,scaleY:1,skewX:0,x:940.5},17,cjs.Ease.get(1)).to({startPosition:0},40).to({startPosition:0},5).to({startPosition:0},8).to({startPosition:0},58).to({startPosition:0},10).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(130).to({_off:false},0).to({startPosition:0},101).to({startPosition:0},5).to({startPosition:0},8).to({startPosition:0},58).to({startPosition:0},10).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(130).to({_off:false},0).to({startPosition:0},11).to({skewX:-1},6,cjs.Ease.get(1)).to({startPosition:0},27).to({skewX:0},17,cjs.Ease.get(1)).to({startPosition:0},40).to({startPosition:0},5).to({startPosition:0},8).to({startPosition:0},58).to({startPosition:0},10).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6},{t:this.instance_5}]},130).wait(270));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(130).to({_off:false},0).to({startPosition:0},11).to({x:883.4},6,cjs.Ease.get(1)).to({startPosition:0},27).to({x:893},17,cjs.Ease.get(1)).to({startPosition:0},40).to({startPosition:0},5).to({startPosition:0},8).to({startPosition:0},58).to({startPosition:0},10).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({y:222.7},4).to({y:218.7},20).to({startPosition:0},11).to({regX:0.1,regY:0.1,x:894,y:218.8},25).to({scaleY:0.99,rotation:-0.8,x:888,y:221.1},4).to({scaleY:1,rotation:-2.9,x:875.9,y:219.3},8).wait(17).to({rotation:-2.9},0).to({regY:0.2,rotation:-2.3,x:879.7,y:225},5).to({regY:0.1,rotation:-1.2,x:886.4,y:218.9},9).to({regX:0,regY:0,rotation:0,x:893.6,y:218.7},11).to({_off:true},16).wait(270));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({y:204.2},4).to({y:200.2},20).to({startPosition:0},11).to({regY:-44.1,rotation:-3,x:892.9,y:200.3},25).to({scaleY:0.99,rotation:-3.8,x:886.5,y:202.6},4).to({scaleY:1,rotation:-5.9,x:873.8,y:200.9},8).wait(17).to({startPosition:0},0).to({regY:-44,scaleX:1,scaleY:0.98,rotation:0,skewX:-5.4,skewY:-5.2,x:877.8,y:208.4},5).to({regY:-44.1,scaleX:1,scaleY:1,rotation:-4.2,skewX:0,skewY:0,x:884.9,y:200.4},9).to({regY:-44.2,rotation:0,x:892.5,y:200.2},11).to({_off:true},16).wait(270));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({x:896.3},25).to({regX:0.1,scaleY:0.99,rotation:-0.8,x:891,y:254.1},4).to({regY:0.1,scaleY:1,rotation:-2.9,x:880,y:252.5},8).wait(17).to({rotation:-2.9},0).to({rotation:-2.3,x:883.4,y:252.4},5).to({regY:0,rotation:-1.2,x:889.5,y:252.1},9).to({regX:0,rotation:0,x:896},11).to({_off:true},16).wait(270));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({y:211.3},4).to({y:207.3},20).to({startPosition:0},11).to({regX:0.1,regY:0.1,x:894,y:207.4},25).to({scaleY:0.99,rotation:-0.8,x:887.8,y:209.8},4).to({scaleY:1,rotation:-2.9,x:875.3,y:207.9},8).wait(17).to({rotation:-2.9},0).to({regY:0.2,rotation:-2.3,x:879.2,y:213.7},5).to({regY:0.1,rotation:-1.2,x:886.1,y:207.5},9).to({regX:0,regY:0,rotation:0,x:893.6,y:207.3},11).to({_off:true},16).wait(270));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({skewX:-0.1,x:815.7,y:787.1},4).to({skewX:-0.6,x:814.2,y:787},8).wait(17).to({startPosition:0},0).to({skewX:-0.3,x:815,y:787.1},5).to({skewX:0,x:816.5,y:787},9).to({startPosition:0},11).to({_off:true},16).wait(270));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({startPosition:0},4).to({startPosition:0},8).wait(17).to({startPosition:0},0).to({startPosition:0},5).to({startPosition:0},9).to({startPosition:0},11).to({_off:true},16).wait(270));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({startPosition:0},4).to({startPosition:0},8).wait(17).to({startPosition:0},0).to({startPosition:0},5).to({startPosition:0},9).to({startPosition:0},11).to({_off:true},16).wait(270));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({startPosition:0},4).to({startPosition:0},8).wait(17).to({startPosition:0},0).to({startPosition:0},5).to({startPosition:0},9).to({startPosition:0},11).to({_off:true},16).wait(270));
...
// stage content:
(lib._11DialupFWS = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(246.6,709.3,0.695,0.695,0,0,0,893.8,1052.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(400));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(377.6,364,207.8,703.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"/sounds/dialup/DialupFlatworld.mp3", id:"DialupFlatworld"}
	],
	preloads: []
};
