...
(lib.Tween6copy3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("");
...
(lib.Symbol8copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DEB180").s().p("");
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("");
...
(lib.LEFTSHOULDERcopy3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("AhjtPQESCYAqIOIBTIyQgNAGgNAGAElMkQAAgCAAgCQAEgsgDg9IgSkCIgCggAjGHaQDrAhDjhiQAFgCAFgCAkrjRIA+KlQATADAUADIA/F2");
	this.shape.setTransform(31.5,87.6);
...
(lib.LEFTARMcopy3 = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DEB180").s().p("AhUN2Qh9gOAJihIAEgrQAwjhgVk3QgusJAdipQAuhEBagEQC8gHA2BrQAFAJADAKIACAEIAAABIAAACIgCgHIgIgBQgSG1hZOIIAJACIgaCoQgcCQhnAAIgVgBg");
...
(lib.HANDcopy5 = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(2,1,1).p("");
...
(lib.HANDcopy4 = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(2,1,1).p("");
...
(lib.BODYcopy4 = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A4A").s().p("");
	this.shape_3.setTransform(120.2,192.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2D2D2D").s().p("AOWWNIgDgFIga05QgUoqCSnlIAAgBIAHgVIBij+QAkhPAkg6QgLBCgQBGIgtABIAtAAQggCMgzCbQgJAghDEqQg8EFAMHoIAECQQAZJVATHaQgkAlg0AfgAuQWNQgzgfgkglQASnaAZpVIAFiQQALnog7kFQhEkqgIggQgzibggiMIAqAAIBlD+IAGAVIABABQCSHlgUIqIgbU5IgCAFgAxczUgAyHzVQgRhOgMhJIgDggQAiBOApBqg");
...
(lib.Tween7copy4 = function(mode,startPosition,loop) {
	...
	// LEFT SHOULDER
	this.instance_4 = new lib.LEFTSHOULDERcopy4("synched",0);
...
(lib.Tween6copy4 = function(mode,startPosition,loop) {
	...
	// Layer 5
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#DEB180").s().p("AgEDXQhWgCg7hAQg7hBAChYQAChZA9g9QA+g+BVACQBWACA7BAQA8BBgCBYQgCBZg+A9Qg8A8hSAAIgFAAg");
	this.shape.setTransform(-10.6,-34.3);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(4).to({_off:false},0).wait(150));
	...
	this.instance_1 = new lib.HANDcopy4("synched",52);
	this.instance_1.parent = this;
	...
	// LEFT ARM
	this.instance_2 = new lib.LEFTARMcopy5("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-10.6,-37.8,1,1,0,0,180,22.6,11.7);

	this.instance_3 = new lib.LEFTARMcopy4("synched",52);
	this.instance_3.parent = this;
...
(lib.Thalay = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({startPosition:36},0).wait(2).to({startPosition:21},0).wait(2).to({startPosition:26},0).wait(2).to({startPosition:21},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:16},0).wait(5).to({startPosition:0},0).wait(7).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:16},0).wait(3).to({startPosition:0},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:16},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:5},0).wait(3).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:16},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(4).to({startPosition:41},0).wait(7).to({startPosition:5},0).wait(4).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:5},0).wait(9).to({startPosition:0},0).wait(7).to({startPosition:31},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:21},0).wait(4).to({startPosition:16},0).wait(4).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(5).to({startPosition:0},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:0},0).wait(2).to({startPosition:16},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:21},0).wait(1).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(3).to({startPosition:5},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:41},0).wait(3).to({startPosition:36},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:16},0).wait(3).to({startPosition:36},0).wait(1).to({startPosition:41},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:16},0).wait(3).to({startPosition:0},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:16},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:26},0).wait(3).to({startPosition:41},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:10},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:5},0).wait(2).to({startPosition:36},0).wait(2).to({startPosition:31},0).wait(2).to({startPosition:36},0).wait(6).to({startPosition:0},0).wait(197));
...
(lib.Symbol2copy = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjpgZQgIAxAqAKQABAAACAAQAKAAAKABAjpgZQAUgIAYgCQAQgCAOACQA1AHANAxQgoANgrABAjHAiQgogEgrgPQATgbAegNACZgDQARgCAXAEQARACAPAFQAFAugjAMAifgjQASAvgjAXACmA9QAOACAPABACmA9QgjgGgigMQANgpArgFQgUApAhAXgAkGgoQBBgkBJATACNgjQBIgEA0An");
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAjpAAQALAeAegBQAfgBAJgbQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQAsgDAlAEACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALACVAbQAngEAlAKACVgfQA8gGAvAi");
	...
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1,1,1).p("AkIAKQBUA0BSgzQhcAbhKgcgAjzguQApgXA1AIABoAfQBXA6BKgtQhIAYhZglgAChgkQAzgBAhAX");
	...
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAjpAAQALAeAegBQAfgBAJgbQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQAsgDAlAEACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALACVgfQA8gGAvAiACVAbQAngEAlAK");
	...
	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjpgZQAUgIAYgCQAQgCAOACQA1AHANAxQgoANgrABAjpgZQgIAxAqAKQABAAACAAQAKAAAKABAjHAiQgogEgrgPQATgbAegNACZgDQARgCAXAEQARACAPAFQAFAugjAMAifgjQASAvgjAXACmA9QAOACAPABACmA9QgjgGgigMQANgpArgFQgUApAhAXgAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_18.setTransform(59.4,68.4);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#000000").ss(1,1,1).p("AjzguQApgXA1AIAkIAKQBUA0BSgzQhcAbhKgcgAChgkQAzgBAhAXABoAfQBXA6BKgtQhIAYhZglg");
	this.shape_19.setTransform(59.2,69.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_20.setTransform(59.3,68);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_21.setTransform(59.4,68.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("ADDAhIgPgBIgIgCIACAAQARgGANgUQA0AIAbANQglAIgkAAIgPAAgABhAMIAXgIIAAABQADALAJAHQgSgFgRgGgAjEADIgDAAIgRgCIAIgBQARgFAHgbIABAAIAAAAQA/ALAbAMQgoAMgrABIgUgBgAkagPQAMgGAJgCQAFAMAIAGQgQgEgSgGg");
	this.shape_22.setTransform(59.4,71.5);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#323232").s().p("AC5AiIgFgBQgLgDgHgGQgKgHgDgLQAmgJAuAIQgNAUgRAGIgCABQgGACgJAAgAjagEQgJgGgFgMQAggLAsACIADgCIgBACIgBAAIgBAAIABAAQgHAbgRAEIgHACIgHAAIgBABQgPAAgJgHgAibgfg");
	this.shape_23.setTransform(56.5,71.4);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("#000000").ss(1,1,1).p("AjwAdQAHAEAKACQABAAACABQAKAAAKAAQAjgWgSgvQgOgBgTAFQgTAGgXAPAjwAdQgUgFgWgHQAKgQAOgKIAAABQAAAZASAMgAB9AHIAAAAQAWgLAXABQAYABAKADQACA1gdAGQgVAFgWgJIAAAAAB9AHQgKAeATATQgTgFgSgGQAIgbAUgLgAi3ghQBNAGANAyQgoANhDAAAkGgmQBBglBJATACNghQBIgEA0AmADMABQA+AWARAjQgsAKg+gI");
	this.shape_24.setTransform(59.4,68.3);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("ACxAuQAbgGAAgsIAAgIQA+AUARAjQgZAGgfAAQgXAAgbgDgADMgMIAAAIQAAAsgbAGQAYgHADgzgABhAeQAIgaAUgLQgKAdATATQgTgEgSgHgAi3gwQBNAHANAxQgoANhDABQAogWgXgwgAkaACQAKgOAOgLIAAAAQAAAZASAMQgUgFgWgHg");
	this.shape_25.setTransform(59.4,69.7);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#323232").s().p("ACiAqIAAAAQgUgTALgdIAAAAQAVgLAYAAQAYABAJAFQgCAzgYAHQgHABgHAAQgOAAgPgGgAjAAWIgDAAQgKgDgHgEQgTgMABgZQAWgPAUgFQATgGAOABQASAvgkAXIgTgBg");
	this.shape_26.setTransform(56.6,69.6);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_27.setTransform(59.3,68);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#323232").s().p("ACsAyIgBAAQgJgGgGgJQgJgOADgQQAEgQAOgKQAGgEAFgCQAJgDALADIAEABQAGACAFAEQAFAEAEAGQAJAOgDARQgEARgOAIIgHAHgAjAAXIgBgBIgDAAIgCAAIgFAAIgDgBIgJgHQgNgLgBgQQgBgKAEgIQAZgWAhAAIAGAFQANAMACARQABARgLALQgHAKgLAEIgIAAIgJAAg");
	this.shape_28.setTransform(56.6,68.6);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("");
	this.shape_29.setTransform(59.3,69);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjHAiQgogEgrgPQATgbAegNQgIAxAqAKQABAAACAAQAKAAAKABAjpgZQAUgIAYgCQAQgCAOACQASAvgjAXACZgDQgUApAhAXQgjgGgigMQANgpArgFQARgCAXAEQARACAPAFQAFAugjAMACmA9QAOACAPABAifgjQA1AHANAxQgoANgrABAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_30.setTransform(59.4,68.4);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAiYABQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQALAeAegBQAfgBAJgbgACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALAjpAAQAsgDAlAEACVgfQA8gGAvAiACVAbQAngEAlAK");
	this.shape_31.setTransform(59.4,68.7);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("#000000").ss(1,1,1).p("AC7A8QAEAAAEABQAsACAsgKQgbgNgfgHAiYABQAgAFAbAMQgoANgrABQgKgBgKAAQgCAAgBAAQgogEgrgPQACgCABgCQAagGAUgCQALAeAegBQAfgBAJgbgACVAbQgbADgZAKQAiAMAjAGQAHABAHABQADAAADAAIABAAQAgAAAGgbACVAbQADAZAcAIAj+gnQA6gdA5ALAjpAAQAsgDAlAEACVAbQAngEAlAKACVgfQA8gGAvAi");
	this.shape_32.setTransform(59.4,68.7);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("#000000").ss(1,1,1).p("ADhAGQApAPARAjQgsAKgsgCAjHAiQgogEgrgPQATgbAegNQAUgIAYgCQAQgCAOACQASAvgjAXAjHAiQABAAACAAQAKAAAKABAjpgZQgIAxAqAKACZgDQgUApAhAXQgjgGgigMQANgpArgFQARgCAXAEQARACAPAFQAFAugjAMACmA9QAOACAPABAifgjQA1AHANAxQgoANgrABAkGgoQBBgkBJATACNgjQBIgEA0An");
	this.shape_33.setTransform(59.4,68.4);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_34.setTransform(59.3,68);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_35.setTransform(59.3,68);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},12).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_15}]},2).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},9).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_18}]},23).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_19}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_15}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_16}]},1).to({state:[{t:this.shape_17},{t:this.shape_3},{t:this.shape_1},{t:this.shape_20}]},8).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},80).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21}]},2).to({state:[{t:this.shape_26},{t:this.shape_25},{t:this.shape_7},{t:this.shape_24}]},1).to({state:[{t:this.shape_29},{t:this.shape_28},{t:this.shape_1},{t:this.shape_27}]},1).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_7},{t:this.shape_30}]},24).to({state:[{t:this.shape_11},{t:this.shape_9},{t:this.shape_10},{t:this.shape_31}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_32}]},2).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_33}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_1},{t:this.shape_34}]},1).to({state:[{t:this.shape_17},{t:this.shape_3},{t:this.shape_1},{t:this.shape_35}]},8).wait(275));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},12).to({x:57.8,y:55.2},2).to({x:57.7,y:54.2},3).to({y:54.4},4).to({startPosition:0},6).to({startPosition:0},22).to({y:54.2},1).to({x:57.8,y:55.2},3).to({x:57.7,y:54.4},2).to({startPosition:0},8).to({startPosition:0},5).to({rotation:-4.5,x:57.8},1).to({regX:0.1,regY:0.1,rotation:-4.3,x:58,y:54.5},9).to({scaleX:1,scaleY:1,x:58.1,y:55.8},2).to({regY:0.2,y:52.1},9,cjs.Ease.get(1)).to({startPosition:0},9,cjs.Ease.get(1)).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:-4.4,x:57.7,y:54.4},6,cjs.Ease.get(1)).to({startPosition:0},18).to({startPosition:0},8).to({x:57.8,y:55.2},2).to({x:57.7,y:54.2},3).to({y:54.4},4).to({startPosition:0},6).to({regX:0.1,regY:0.1,rotation:-4.3,x:57.8,y:54.9},3).to({x:57.9,y:51.8},5).to({regX:0,regY:0,rotation:-4.4,x:57.7,y:54.2},6).to({startPosition:0},11).to({x:57.8,y:55.2},3).to({x:57.7,y:54.4},2).to({startPosition:0},8).to({startPosition:0},5).to({rotation:-4.5,x:57.8},1).wait(274));

	// Layer 1
	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f().s("#000000").ss(1,1,1).p("AmqBiQAdAEAfCAIAdlcIgNiyQATgNAUgMQCqheEUAzQCagcB5BRIAQDNIAfEUAHnDRQgXgqgDBMQgBAYgBARQgDASgCAMQgDAQgFAGQgbA8AcgQAnmC5QAJgLAIgHQA4gzABBnQAAAegVAQQggARAtAkQAwAlgiAUAAgEMQAJgLAogGADliLQhLAnAABhQAEB1ATBxQgGAQhQAj");
	this.shape_36.setTransform(48.9,68.9);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f().s("#000000").ss(2,1,1).p("AGVFuIgOBMQgSBBgeAdQgoA5gvAyQg8A+hHA0Ih6AAQhLgvg4glQglgXgcgVQhHg1gLgbIg7iiIgMghQiOAsgfjcQgUiEBugGIgKh9IgTj5QggAPgmArQAblhGVhiQHchoB+EMQAXBJg5BYQBIAxgTBZIghCxIgiCwQA5ATgPBOIgnCPQgLApgtgEgAHKBZIgFAXIgwD+");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36}]}).wait(463));
...
(lib.Symbol9copy = function(mode,startPosition,loop) {
	...
	// HEAD
	this.instance = new lib.Symbol2copy("synched",110);
	this.instance.parent = this;
	this.instance.setTransform(899.6,195.7,1,1,1.5,0,0,54.2,151.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(130).to({_off:false},0).to({startPosition:142},12).to({regX:54.4,rotation:-1.5,x:899.8,startPosition:150},8,cjs.Ease.get(1)).to({_off:true},314).wait(284));
	...
	this.instance_3 = new lib.Tween6copy3("synched",0);
	this.instance_3.parent = this;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},131).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]},1).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9}]},1).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},9).to({state:[{t:this.instance_3}]},6).to({state:[{t:this.instance_3}]},6).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_15}]},16).to({state:[{t:this.shape_17},{t:this.shape_10},{t:this.shape_16}]},1).to({state:[{t:this.shape_18},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19}]},1).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},6).to({state:[{t:this.instance_2}]},14).to({state:[{t:this.instance_2}]},12).to({state:[]},250).wait(284));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(131).to({_off:false},0).wait(1).to({x:774.5,y:597.4},0).to({_off:true},1).wait(47).to({_off:false},0).wait(1).to({x:779.5,y:597.6},0).wait(1).to({x:784},0).to({x:776},6,cjs.Ease.get(0.7)).to({x:784},14,cjs.Ease.get(1)).to({x:781},12,cjs.Ease.get(1)).to({_off:true},250).wait(284));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(138).to({_off:false},0).to({regX:46.9,rotation:-9.7,x:653,y:413.2},9,cjs.Ease.get(0.85)).to({regX:47,regY:18.3,rotation:-20.1,x:654.8,y:415.8},6,cjs.Ease.get(1)).to({regX:47.1,regY:18.4,rotation:-24.4,x:655,y:415.9},6,cjs.Ease.get(1)).to({_off:true},16).wait(573));

	// LEFT HAND
	this.instance_4 = new lib.HANDcopy3("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(785,597.6,1,1,0,0,180,25.6,49.7);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(130).to({_off:false},0).to({_off:true},1).wait(617));

	// Layer 2
	this.instance_5 = new lib.LEFTARMcopy3("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(1021.5,393.5,1,1,0,0,0,22.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(130).to({_off:false},0).to({startPosition:0},4).to({regY:0.1,rotation:-1.2,x:1021.6,y:393.6},8,cjs.Ease.get(1)).to({rotation:0.9},9,cjs.Ease.get(1)).to({regY:0,rotation:0,x:1021.5,y:393.5},11,cjs.Ease.get(1)).to({startPosition:0},19).to({startPosition:0},4).to({regY:0.1,rotation:-1.2,x:1021.6,y:393.6},8,cjs.Ease.get(1)).to({rotation:0.9},9,cjs.Ease.get(1)).to({regY:0,rotation:0,x:1021.5,y:393.5},11,cjs.Ease.get(1)).to({_off:true},251).wait(284));

	// LEFT ARM
	this.instance_6 = new lib.LEFTARMcopy3("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(767.3,482.2,1,1,0,0,180,22.5,88.7);
	this.instance_6._off = true;

	this.instance_7 = new lib.LEFTARMcopy3("synched",0);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_50},{t:this.shape_49},{t:this.shape_48}]},130).to({state:[]},334).wait(284));

	// ID
	this.instance_16 = new lib.Symbol6copy3("synched",0);
	this.instance_16.parent = this;
	this.instance_16.setTransform(892.3,219.7,1,1,0,0,0,25.9,-24.7);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(130).to({_off:false},0).to({startPosition:0},5).to({rotation:1,x:892.4},4).to({regY:-24.6,rotation:-0.5,y:219.8},4).to({regY:-24.7,rotation:0,x:892.3,y:219.7},5).to({_off:true},316).wait(284));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_51).wait(130).to({_off:false},0).to({_off:true},334).wait(284));
	...
	this.shape_53.graphics.f("#C2894C").s().p("AhSEaIjblSIAVh/QAPhRBMgeIBxgSIBWAGIAjAFQBFAJAzARIAOAEIAXAKIAEACQARAIAOAKQAMAIAKAJQAaAYAKAfIADAIIAAABIAAAJQAAATgIAdIjNGBQgnAfgrAAQgoAAgtgfgAEihnQgJAxgCAaQACgaAJgxQAIgdAAgTIAAgJQAIAfgHAmQgDAigRAdIgHANgAEqigIAAAAg");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_54},{t:this.shape_53},{t:this.shape_52}]},130).to({state:[]},334).wait(284));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(130).to({_off:false},0).to({startPosition:0},5).to({y:575.6},7).to({y:577.2},10).to({_off:true},312).wait(284));
...
(lib.Wholeguycopy = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(460));

	// Layer 22
	this.instance = new lib.Symbol9copy("synched",130);
	this.instance.parent = this;
	this.instance.setTransform(893,581.2,1,1,0,0,0,894.1,582.3);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(130).to({_off:false},0).to({startPosition:137},7).to({scaleY:0.99,startPosition:141},4).to({regY:582.2,scaleY:1.01,skewX:-1.8,skewY:-1,x:886.6,startPosition:147},6,cjs.Ease.get(1)).to({startPosition:174},27).to({regY:582.3,scaleY:0.99,skewX:0,skewY:0,x:893,startPosition:182},8,cjs.Ease.get(1)).to({scaleY:1,startPosition:191},9).wait(273));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(130).to({_off:false},0).to({startPosition:0},11).to({scaleY:1,skewX:-2.1,x:844.3,y:803.4},6,cjs.Ease.get(1)).to({y:801.8},27).to({scaleY:1,skewX:0,x:846.8},17,cjs.Ease.get(1)).wait(273));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(130).to({_off:false},0).to({startPosition:0},11).to({regX:45.1,scaleY:1,skewX:-1.9,x:940.7,y:800.2},6,cjs.Ease.get(1)).to({y:801.8},27).to({regX:45,scaleY:1,skewX:0,x:940.5},17,cjs.Ease.get(1)).wait(273));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(130).to({_off:false},0).wait(334));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(130).to({_off:false},0).to({startPosition:0},11).to({skewX:-1},6,cjs.Ease.get(1)).to({startPosition:0},27).to({skewX:0},17,cjs.Ease.get(1)).wait(273));

	// SHOE
	this.instance_5 = new lib.LEFTSHOEcopy3("synched",0);
	this.instance_5.parent = this;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6},{t:this.instance_5}]},130).wait(334));

	// PELVIC
	this.instance_7 = new lib.Tween7copy3("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(893,615.6,1,1,0,0,0,0,43.1);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(130).to({_off:false},0).to({startPosition:0},11).to({x:883.4},6,cjs.Ease.get(1)).to({startPosition:0},27).to({x:893},17,cjs.Ease.get(1)).wait(273));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({y:204.2},4).to({y:200.2},20).to({startPosition:0},11).to({regY:-44.1,rotation:-3,x:892.9,y:200.3},25).to({scaleY:0.99,rotation:-3.8,x:886.5,y:202.6},4).to({scaleY:1,rotation:-5.9,x:873.8,y:200.9},8).wait(17).to({startPosition:0},0).to({regY:-44,scaleX:1,scaleY:0.98,rotation:0,skewX:-5.4,skewY:-5.2,x:877.8,y:208.4},5).to({regY:-44.1,scaleX:1,scaleY:1,rotation:-4.2,skewX:0,skewY:0,x:884.9,y:200.4},9).to({regY:-44.2,rotation:0,x:892.5,y:200.2},11).to({_off:true},16).wait(334));

	// Layer 12
	this.instance_13 = new lib.Tween3copy2("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(896,252.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({x:896.3},25).to({regX:0.1,scaleY:0.99,rotation:-0.8,x:891,y:254.1},4).to({regY:0.1,scaleY:1,rotation:-2.9,x:880,y:252.5},8).wait(17).to({rotation:-2.9},0).to({rotation:-2.3,x:883.4,y:252.4},5).to({regY:0,rotation:-1.2,x:889.5,y:252.1},9).to({regX:0,rotation:0,x:896},11).to({_off:true},16).wait(334));

	// Layer 13
	this.instance_14 = new lib.Tween4copy4("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(893.6,207.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({y:211.3},4).to({y:207.3},20).to({startPosition:0},11).to({regX:0.1,regY:0.1,x:894,y:207.4},25).to({scaleY:0.99,rotation:-0.8,x:887.8,y:209.8},4).to({scaleY:1,rotation:-2.9,x:875.3,y:207.9},8).wait(17).to({rotation:-2.9},0).to({regY:0.2,rotation:-2.3,x:879.2,y:213.7},5).to({regY:0.1,rotation:-1.2,x:886.1,y:207.5},9).to({regX:0,regY:0,rotation:0,x:893.6,y:207.3},11).to({_off:true},16).wait(334));

	// BODY
	this.instance_15 = new lib.BODYcopy4("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(893.6,384.5,1,1,0,0,0,120.2,192.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({regY:193,scaleY:0.99,y:387},4).to({regY:192.8,scaleY:1,y:384.5},20).to({startPosition:0},11).to({x:893.9},25).to({regX:120.4,scaleX:1,scaleY:0.99,rotation:-0.8,x:890.9,y:385.7},4).to({regY:193,scaleX:1.02,scaleY:1,rotation:-2.9,x:884.4,y:384.9},8).wait(17).to({rotation:-2.9},0).to({scaleY:0.98,rotation:0,skewX:-2.3,skewY:-2.2,x:886.4,y:388.6},5).to({regY:192.9,scaleY:1,rotation:-1.2,skewX:0,skewY:0,x:890,y:384.6},9).to({regX:120.2,regY:192.8,scaleX:1,rotation:0,x:893.6,y:384.5},11).to({_off:true},16).wait(334));

	// LEFT THIGH
	this.instance_16 = new lib.LEFTTHIGHcopy4("synched",0);
	this.instance_16.parent = this;
	this.instance_16.setTransform(846.8,681.1,1,1,0,0,180,45,119.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({regX:44.9,scaleY:1,x:845.8,y:680.9},4).to({scaleY:1,skewX:-0.6,x:843.5,y:680.4},8).wait(17).to({startPosition:0},0).to({regY:119.8,scaleY:1,skewX:-0.3,x:844.7,y:680.7},5).to({regX:45,regY:119.7,scaleY:1,skewX:0,x:846.8,y:681.1},9).to({startPosition:0},11).to({_off:true},16).wait(334));

	// LEFT THIGH
	this.instance_17 = new lib.LEFTTHIGHcopy4("synched",0);
	this.instance_17.parent = this;
	this.instance_17.setTransform(940.5,681.1,1,1,0,0,0,45,119.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({scaleY:1.01,skewX:-0.5,skewY:-1.5,x:939.3,y:680.5},4).to({scaleX:1,scaleY:1.03,skewX:-1.8,skewY:-4.7,x:937.1,y:679.2},8).wait(17).to({startPosition:0},0).to({regY:119.8,scaleX:1,scaleY:1.02,skewX:-1,skewY:-3,x:938.3,y:680},5).to({regY:119.7,scaleY:1,skewX:0,skewY:0,x:940.5,y:681.1},9).to({startPosition:0},11).to({_off:true},16).wait(334));

	// LEFT LEG
	this.instance_18 = new lib.LEFTLEGcopy4("synched",0);
	this.instance_18.parent = this;
	this.instance_18.setTransform(816.5,787,1,1,0,0,180,57,17.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({skewX:-0.1,x:815.7,y:787.1},4).to({skewX:-0.6,x:814.2,y:787},8).wait(17).to({startPosition:0},0).to({skewX:-0.3,x:815,y:787.1},5).to({skewX:0,x:816.5,y:787},9).to({startPosition:0},11).to({_off:true},16).wait(334));

	// LEFT LEG
	this.instance_19 = new lib.LEFTLEGcopy4("synched",0);
	this.instance_19.parent = this;
	this.instance_19.setTransform(972.5,795,1,1,0,0,0,59,25.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({startPosition:0},4).to({startPosition:0},8).wait(17).to({startPosition:0},0).to({startPosition:0},5).to({startPosition:0},9).to({startPosition:0},11).to({_off:true},16).wait(334));

	// LEFT SHOE
	this.instance_20 = new lib.LEFTSHOEcopy4("synched",0);
	this.instance_20.parent = this;
	this.instance_20.setTransform(859.7,1011.2,1,1,0,0,180,0,41.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_20).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({startPosition:0},4).to({startPosition:0},8).wait(17).to({startPosition:0},0).to({startPosition:0},5).to({startPosition:0},9).to({startPosition:0},11).to({_off:true},16).wait(334));

	// LEFT SHOE
	this.instance_21 = new lib.LEFTSHOEcopy4("synched",0);
	this.instance_21.parent = this;
	this.instance_21.setTransform(963.2,1011.2,1,1,0,0,0,35.5,41.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({startPosition:0},4).to({startPosition:0},8).wait(17).to({startPosition:0},0).to({startPosition:0},5).to({startPosition:0},9).to({startPosition:0},11).to({_off:true},16).wait(334));

	// Layer 21
	this.instance_22 = new lib.Tween5copy("synched",0);
	this.instance_22.parent = this;
	this.instance_22.setTransform(893,572.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_22).to({startPosition:0},4).to({startPosition:0},20).to({startPosition:0},11).to({startPosition:0},25).to({skewX:-0.3,skewY:-1.3,y:572.2},4).to({scaleX:1,skewX:-1.2,skewY:-4.1,y:571.4},8).wait(17).to({startPosition:0},0).to({regX:0.1,regY:0.1,skewX:-1.1,skewY:-3,y:571.9},5).to({regX:0,regY:0,scaleX:1,rotation:-1.2,skewX:0,skewY:0,x:892.9,y:572.6},9).to({rotation:0,x:893,y:572.5},11).to({_off:true},16).wait(334));
...
// stage content:
(lib._06EmploymentFWS = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(264));

	// Layer 3
	this.instance = new lib.Wholeguycopy("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(248.3,710.9,0.698,0.698,0,0,0,893.9,1052.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(268));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(378.9,363.3,208.4,706);
// library properties:
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"/sounds/employment/_34206899.mp3", id:"_34206899"}
	],
	preloads: []
};
