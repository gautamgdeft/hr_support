...
class forntendController extends Controller
{
	...
	public function benifits (){
		$benifitstext = Benifits::all();
		return view ('frontend.benifits', compact('benifitstext'));
	...
	public function fun (){
		...
		return view ('frontend.fun', compact('funtext','funimages'));

	}


	public function dialup (){
		$contacttext = Contact::all();
		return view ('frontend.dialup', compact('contacttext'));
